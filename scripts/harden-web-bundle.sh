...
# control-flow flattening / self-defending / console-disable — those transforms make
# the procedural-generation number/string hot loops pathologically slow and hung the
# canary .exe mid-boot. This profile keeps the app fast and the desktop diagnostic
# console intact. Native builds skip this — Hermes already ships bytecode.
set -euo pipefail
DIST="${1:-dist}"
