...
W();
W('⚠ OTA-1588 — and `checkKind: \'boss\'` is NOT a fight outside a hunt. Thirty');
W('spawn-less boss beats sit across the mysteries and storylines, every one of them');
W('the last actionable stage of its chain, and they are handovers: a mystery\'s boss');
W('is paid by INVESTIGATE and a storyline\'s by DIPLOMACY. They are absent from this');
W('section because their prose promises nothing — the label was the only thing');
W('claiming a fight, and it was misread by three readers before it was found.');
W();
