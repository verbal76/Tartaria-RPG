// ⚠ OTA-1338 — THE SIX-LINE STANDING WALL IS ONE LINE NOW.
//
...
//   · an OTA-1337 ladder-tier crossing is ALWAYS named, both directions, with the
...
describe('OTA-1338 — one vague line, named thresholds', () => {
