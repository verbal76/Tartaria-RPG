// ⚠⚠ OTA-1360 — THE SHARED ROLL OF THE FALLEN: the wiring.
//
...
describe('OTA-1360 — identity and the house', () => {
...
describe('OTA-1360 — the exchange', () => {
...
describe('OTA-1360 — the spawner join', () => {
...
describe('OTA-1360 — the store wiring, locked at the source', () => {
...
describe('OTA-1360 — the handshake', () => {
