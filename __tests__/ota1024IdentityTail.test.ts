// OTA-1024 — the identity tail (snapshot-audit batch D): the remaining ~25
...
describe('OTA-1024 — sections and slots read canonical identity', () => {
...
describe('OTA-1024 — the store-side cluster is canonical (source locks)', () => {
...
describe('OTA-1024 — engine sites canonical (source locks)', () => {
