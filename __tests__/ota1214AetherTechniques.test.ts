...
describe('⚠⚠ OTA-1214 — SCIENCE, NOT MAGIC. The vocabulary is the design.', () => {
  test('no technique, effect or line uses spell-caster language', () => {
    ...
    // these words are avoided, and matching its own explanation would be the OTA-1205 trap
...
describe('⚠⚠ OTA-1214 — the dose is SCALED by tier', () => {
...
describe('⚠⚠ OTA-1214 — growth is PER-TECHNIQUE, and it buys reliability', () => {
...
describe('⚠⚠ OTA-1214 — THE ANTI-FARM GUARD. Growth-through-use is farmable by construction.', () => {
...
describe('OTA-1214 — knowing and attempting', () => {
...
describe('OTA-1214 — name lookup refuses to guess', () => {
