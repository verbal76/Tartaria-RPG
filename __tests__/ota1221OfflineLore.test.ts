...
// PLAYER can see.
// OTA-1219 — LOOP AUDIT, BATCH 4 — the last of the WIRED rows.
// OTA-1221 — PUNCHLIST P17: the lore loop no longer needs the narration model.
//
...
describe('OTA-1221 / P17 — the offline matcher', () => {
...
describe('OTA-1221 / P17 — LIVE, with no narration model at all', () => {
...
describe('OTA-1221 / P17 — the address is not the topic', () => {
  beforeAll(() => { console.log = () => {}; console.warn = () => {}; console.error = () => {}; });
