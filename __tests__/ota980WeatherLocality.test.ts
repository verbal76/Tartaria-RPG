...
// OTA-980 — #122: weather locality. Root cause: pickWeather weighed only
...
describe('OTA-980 — weather reads the ground it falls on', () => {
  ...
  it('category lock: roof suppression + gap 5 + biased call sites are wired in source', () => {
    ...
    // OTA-1103 — RETARGETED. The bare set-membership check became
