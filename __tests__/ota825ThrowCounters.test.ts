// OTA-1110 — exploit close (reverify workflow, CONFIRMED high-severity). A thrown
...
it('OTA-1110 — throwing at a surviving enemy draws an enemy counter (no free ranged loop)', async () => {
