// OTA-1212 — THE MARKET TRUCE, AS LAW. Owner, after a Conspiracy Architects
...
describe('OTA-1212 — the one spelling of the truce', () => {
...
describe('OTA-1212 — all four doors consult it', () => {
