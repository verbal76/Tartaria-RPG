// OTA-1004 — the craft screen stops stalling. ingredientShortfall annotated the
...
describe('OTA-1004 — the craft badge computes in milliseconds, not seconds', () => {
...
describe('OTA-1004 — canCraft agrees with the drain (exact-ingredient exclusion parity)', () => {
