...
describe('OTA-1010 — a finished mission announces itself', () => {
  ...
  it('CATEGORY LOCK: every completion path goes through the choke point', () => {
    ...
    // not a paren, so it is deliberately not counted here. OTA-1050 — story
    ...
    // ⚠ RETARGETED BY OTA-1206, which added an eighth site (Collection — a completed
    ...
    // OTA-1050 — story threads bypass the notice entirely (no popup): nothing
