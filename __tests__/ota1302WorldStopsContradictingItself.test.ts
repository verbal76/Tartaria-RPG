...
// ⚠⚠ OTA-1302 — FOUR THINGS THE OWNER'S 4.29.206 WALK SHOWED, ALL OF THEM
...
//      not rebuild the scene, so OTA-1256's pinned arrival-tile gear followed
...
describe('OTA-1302 — the world stops contradicting itself', () => {
  ...
  describe('the gear stays on the tile you left', () => {
    ...
    it('⚠ each tile still carries its OWN gear — OTA-1256\'s complaint stays fixed', async () => {
      await outsideTheGate();
