// OTA-1194 — PUNCHLIST P11 CLOSED. HAL brought up to golem's version: the EXIT chip
...
// the same thing, with the OTA-1186 and tutorial cases added.
...
describe('OTA-1194 — the gate is the way out', () => {
...
describe('⚠⚠ OTA-1194 — the rule survives OTA-1186’s per-site skins', () => {
...
describe('⚠⚠ OTA-1194 — the fallback is the point', () => {
