...
//
// That is the same failure as the `hunger` difficulty dial OTA-1117 deleted:
...
describe('OTA-1118 — nothing in the running game touches hunger', () => {
...
describe('OTA-1118 — the three unreachable lines are gone', () => {
...
describe('OTA-1118 — the cap has one owner and it cannot shrink', () => {
...
describe('OTA-1118 — the field is labelled a fossil so nobody wires it again', () => {
...
describe('OTA-1118 — ⚠ the DOG\'s feeding clock is a different system and still lives', () => {
