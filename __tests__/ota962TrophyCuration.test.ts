// OTA-962 — the curated trophy pass: 35 iconic boss/creature trophies promoted from
...
describe('OTA-962 — promoted trophy materials are real catalog rows', () => {
...
describe('OTA-962 — provable synonym aliases', () => {
