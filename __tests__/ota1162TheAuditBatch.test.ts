...
// (OTA-1151..1161). The re-derivation swept every claim those OTAs made
...
//      instance. Found by the sweep OTA-1158 said should never be needed
...
//
//   2. The EnemyPanel printed `e.damage` raw in two places — OTA-1159's boss
...
//      a 5-second call. That impossible sample fed OTA-1150's ms/tok range
...
describe('OTA-1162 audit №1 — the Power gauge reads the ONE AC', () => {
...
describe('OTA-1162 audit №2 — the enemy panel tells the boss truth in chip width', () => {
...
describe('OTA-1162 audit №3 — the bank pre-synthesizes what will be SPOKEN', () => {
...
describe('OTA-1162 audit №4 — an impossible prefill cannot move the ms/tok range', () => {
