// OTA-1207 — COMPLETED STORIES NOW GRANT PERMANENT BUFFS.
//
...
describe('OTA-1207 — only a COMPLETED set pays', () => {
...
describe('⚠⚠ OTA-1207 — EVERY PERK HAS A CONSUMER. This is the whole rule.', () => {
