// OTA-1199 — PUNCHLIST P15: a place's own authored loot can now turn up when you search it.
//
...
describe('OTA-1199 / P15 — the substitution', () => {
...
describe('OTA-1199 / P15 — the pool resolver', () => {
