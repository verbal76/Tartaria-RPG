...
describe('OTA-1119 — ⚠ dispose() never reports ready-over-dead', () => {
  ...
  it('⚠ the lifecycle-generation bump still comes first of all', () => {
    // OTA-1084's staleness guard depends on the bump landing before anything
...
describe("OTA-1119 — 'dormant' is an empty with a known cause", () => {
...
describe('OTA-1119 — the death screen holds five seconds longer', () => {
