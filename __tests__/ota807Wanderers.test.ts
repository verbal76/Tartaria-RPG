// OTA-807 — Wandering NPCs. The open road occasionally puts a PERSON in front of
...
describe('OTA-807 — wanderer helpers', () => {
...
// NOTE — the wanderer TALK store flow (single roll, one-shot consume) was reshaped
// into the two-button PARLEY in OTA-808 (a generic opener now stages the modal; a
// specific verb commits). That behavior is covered by __tests__/ota808Parley.test.ts.
// The pure helpers above (makeWanderer determinism, reward tiers) remain in use.
