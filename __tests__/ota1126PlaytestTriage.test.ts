// OTA-1126 — DEVICE-LOG TRIAGE: THE ECHO THAT PAID FOREVER, THE ROOF THAT
...
//
//  2. WEATHER BITES UNDER A FACTION'S ROOF. OTA-1003's "a roof is a roof"
...
describe('OTA-1126 — a memory surfaces once', () => {
  const rooms = {
...
describe('OTA-1126 — the roof follows the faction skin', () => {
...
describe('OTA-1126 — the fall reads HP live', () => {
