// OTA-1187 — LIVE PROOF FOR P8. A finished bounty closes at the faction's own HALL, with
// no vendor standing anywhere in the room.
//
// ⚠ Everything in ota1187ContractFixes pins source and maths. This drives the real store,
...
describe('OTA-1187 / P8 — the faction hall takes its own bounty back', () => {
