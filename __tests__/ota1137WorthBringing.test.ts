...
// OTA-1137 — THE WEAKNESS HAS TO BE WORTH BRINGING.
//
...
// OTA-1136 measured at half its round output. In the owner's own round that is
...
describe('OTA-1137 — ⚠ a weapon hit on a weakness staggers too', () => {
