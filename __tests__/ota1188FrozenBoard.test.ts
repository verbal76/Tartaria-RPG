...
describe('OTA-1188 — the live matrix decides who is a friend', () => {
...
describe('OTA-1188 — applyRepChange honours a frozen snapshot', () => {
  const standing = [
...
describe('OTA-1188 — the deadline finally prices the WAITING', () => {
...
describe('OTA-1188 — every refusal names itself', () => {
...
describe('OTA-1188 — the freeze cycle', () => {
  beforeEach(async () => {
...
describe('OTA-1188 — accepting is gated, and accepting releases', () => {
  const OFFER = {
...
describe('OTA-1188 — the board quotes what it will charge', () => {
  ...
  it('the ACCEPT button stays live when locked, so the tap can explain itself', () => {
    ...
    // explains nothing is the OTA-1187 defect wearing a different hat.
