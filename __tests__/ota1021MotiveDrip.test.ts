...
// OTA-1021 — THE MOTIVE DRIP (story phase 3, closes the arc). Owner: "we
...
describe('OTA-1021 — the authored drip is complete and well-ordered', () => {
...
describe('OTA-1021 — the drip rides real travel arrivals', () => {
...
describe('OTA-1021 — SOURCE LOCKS (category: the drip reaches the game)', () => {
  ...
  // ⚠ OTA-1223 RETARGET — these two pinned the MISSING-ONLY spellings. That path
  ...
  // ota1223EveryMotiveEnds: the kill grants the keepsake and marks the thread,
  ...
  it('the kill path closes the resolved thread: guaranteed beats + keepsake + resolved mark', () => {
    ...
    // finished that trail before OTA-1223 still reads exactly as it did.
