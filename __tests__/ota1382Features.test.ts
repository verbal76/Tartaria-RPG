/**
 * OTA-1382 — Step 3: the intentional differences become ONE config file.
 *
...
describe('OTA-1382 — the product flag', () => {
...
describe('OTA-1382 — platform capability is NOT a flag', () => {
...
describe('OTA-1382 — the migration that was universalised rather than flagged', () => {
...
describe('OTA-1382 — the rule for future differences', () => {
