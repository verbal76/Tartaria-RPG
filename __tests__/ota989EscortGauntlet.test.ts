...
// OTA-989 — the escort GAUNTLET. Owner: "fully run escort missions through
...
describe('OTA-989 — tuning + economics guards', () => {
...
describe('OTA-989 — every pickup source works', () => {
...
describe('OTA-989 — the full gauntlet: every contract, accept to drop-off', () => {
...
describe('OTA-989 — combat, parking, and failure on the road', () => {
