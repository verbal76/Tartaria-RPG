...
describe('OTA-997 — the owner\'s ask, verified: ALL catalog coatings rack', () => {
...
describe('OTA-997 — the throwable side of the gate reads canonical tags too', () => {
...
describe('OTA-997 — every sibling consumer answers from the same canonical reader', () => {
