/**
 * OTA-1364 — a cleared room stays cleared; the one item stops coming back.
 *
...
describe('OTA-1364 — the defect, reproduced', () => {
...
describe('OTA-1364 — the fix: the mask becomes permanent', () => {
...
describe('OTA-1364 — what was NOT touched', () => {
