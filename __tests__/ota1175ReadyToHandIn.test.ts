// OTA-1175 — READY TO HAND IN, and the three definitions of "ready" it had to
// unify first.
//
...
describe('OTA-1175 — the stage kinds (hunts / mysteries / storylines)', () => {
...
describe('OTA-1175 — faction contracts keep all three of their shapes', () => {
  const none = () => 0;
...
describe('OTA-1175 — the broker alliance', () => {
...
describe('OTA-1175 — category lock: the old inline definitions are GONE', () => {
...
describe('OTA-1175 — category lock: NO SECTION IS LEFT OUT OF THE FLOAT', () => {
...
describe('OTA-1175 — category lock: the roll-up is not a second turn-in path', () => {
...
describe('OTA-1175 — the two sort buttons are one mode', () => {
