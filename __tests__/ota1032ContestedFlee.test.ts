// OTA-1032 — THE UNLOSABLE FLEE. Escape was d20 + DEX vs a flat DC 9: at DEX 8+
...
describe('OTA-1032 — the flee is contested by the fastest pursuer', () => {
...
describe('OTA-1032 — category lock: the store wires live pursuers into the escape roll', () => {
