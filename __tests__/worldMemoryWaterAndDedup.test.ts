// OTA-1085 — pure-engine regressions for two of the "small bugs" fixes:
...
describe('OTA-1085 — recordEnemyDefeat de-dupes (bounded distinct-name set)', () => {
  ...
  it('SELF-HEALS a legacy save that already carries duplicates', () => {
    // Simulate a pre-OTA-1085 save with a farmed duplicate stack.
...
describe('OTA-1085 — wild-water re-arm on game-hours per source', () => {
