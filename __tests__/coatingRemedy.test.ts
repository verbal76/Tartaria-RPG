// OTA-1051/765 — coatings are tri-modal (coat weapon / coat armor / drink), but a
...
describe('OTA-1052 — which coatings are drinkable', () => {
...
describe('OTA-1051 — drinkable coating remedies', () => {
