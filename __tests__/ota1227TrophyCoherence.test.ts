// OTA-1227 — TROPHY COHERENCE ACROSS EVERY MINT. The 2026-08-10 audit's pricing gap:
// an uncatalogued part minted by a SEARCH carried no 'trophy' tag and sold at FULL
// rarity base, while the IDENTICAL part minted by a KILL was trophy-halved (OTA-966).
...
// canonical resolver (OTA-961) — instead of lookupCraftedItem, whose uncatalogued
...
describe('OTA-1227 — the resolver the mints now share', () => {
...
describe('OTA-1227 — every noun-harvest mint classifies through resolveLootItem', () => {
