...
// OTA-960 — elevated combat. Owner: "you can be attacked by airborn creatures
...
describe('OTA-960 — firing down the climb needs a weapon that shoots', () => {
...
describe('OTA-960 — the base-camped pack: melee benched, shooters shoot', () => {
...
describe('OTA-960 — summit fights at your level stay ordinary melee', () => {
