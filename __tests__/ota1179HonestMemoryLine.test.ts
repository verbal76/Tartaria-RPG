// OTA-1179 — THE MEMORY LINE SAYS WHAT IT ACTUALLY FREED. IT USED TO LIE, AND IT LIED TO ME.
//
// ⚠⚠ THE MEASUREMENT. Owner's bug report, 2026-08-09, on build 2026-08-09-1177. Five
...
describe('OTA-1179 — the warning line names both native models', () => {
...
describe('OTA-1179 — the release claim is conditional on an actual release', () => {
  ...
  test('the estimate is labelled as one wherever it is printed', () => {
    ...
    // `memory: released the Qwen context` inside a comment quoting the OTA-1175 log and
