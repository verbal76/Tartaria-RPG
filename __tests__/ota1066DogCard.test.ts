/**
 * OTA-1066 — three owner reports against the dog onboarding card.
 *
...
describe('OTA-1066 — the dog name pool', () => {
...
describe('OTA-1066 — ROLL walks a shuffle bag, not a fresh random draw', () => {
  beforeEach(() => _resetDogNameBag());
