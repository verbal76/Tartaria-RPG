...
// OTA-965 — hook escorts. Owner: "we need hook escort missions." A stranded
...
describe('OTA-965 — stranded defs: one rep-0 field escort per faction', () => {
...
describe('OTA-965 — talk to the traveler, CONTINUE, and the contract is yours', () => {
