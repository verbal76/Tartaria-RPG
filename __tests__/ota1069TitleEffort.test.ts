/**
 * OTA-1069 — titles were being handed out in the tutorial.
 *
...
describe('OTA-1069 — one ambient weather tick no longer buys a title', () => {
...
describe('OTA-1069 — the storm titles now take real exposure', () => {
...
describe('OTA-1069 — no title is earnable from a blank slate', () => {
