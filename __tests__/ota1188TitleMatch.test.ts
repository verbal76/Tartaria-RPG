// OTA-1188 — TYPED TURN-IN SURVIVES THE PARSER'S STOP-WORD STRIPPING.
//
...
// so the match failed.
//
// ⚠ IT PREDATES OTA-1188 AND IS NOT ABOUT THE COURIER. It breaks the typed turn-in of any
...
describe('⚠⚠ OTA-1188 — the exact failure that was measured', () => {
...
describe('OTA-1188 — token matching', () => {
...
describe('⚠⚠ OTA-1188 — the new tier is STRICTLY ADDITIVE', () => {
  ...
  test('⚠⚠ THE SUBSTRING TIER NO LONGER GUESSES — closed by OTA-1193 (P12)', () => {
    ...
    // left alone here, because OTA-1188's whole safety argument for dropping a shared
...
describe('⚠ OTA-1188 — all four finders got it, not just the one that failed', () => {
