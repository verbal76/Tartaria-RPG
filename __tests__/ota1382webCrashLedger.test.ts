/**
 * OTA-web10 — crash reporting, staged: capture now, delivery when there is a DSN.
 *
...
describe('OTA-web10 — the ledger keeps more than one', () => {
...
describe('OTA-web10 — the native death finally becomes a crash', () => {
...
describe('OTA-web10 — both JS capture points write the ledger', () => {
...
describe('OTA-web10 — delivery is inert, and needs BOTH switches', () => {
...
describe('OTA-web10 — it reaches the places a human actually looks', () => {
...
describe('OTA-web10 — what was already here and was NOT replaced', () => {
