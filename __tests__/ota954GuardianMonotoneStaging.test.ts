// OTA-954 — Guardian staging is monotone across tiers at ANY fixed player power.
//
...
describe('OTA-954 Guardian monotone staging floor', () => {
  ...
  it('the review-found inversion site stays monotone (power 20: T1 vs T2)', () => {
    // ⚠ RETARGETED for OTA-1165 (owner tuning): tier 1's hpMult went 1.4 → 1.0,
    ...
    // OTA-954 floor is a no-op here. The floor mechanism itself is still
  ...
  it('on-curve fights stage byte-identically to the authored OTA-926 curve', () => {
    ...
    // ⚠ Tier 1 RETARGETED 59 → 42 for OTA-1165 (owner tuning): hpMult 1.4 → 1.0.
