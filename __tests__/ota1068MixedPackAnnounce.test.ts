/**
 * OTA-1068 — "2 Scrap Drones close on you", then a Mud Wasp attacks.
 *
...
describe('OTA-1068 — pluralizeNoun', () => {
...
describe('OTA-1068 — describeEnemyParty', () => {
...
describe('OTA-1068 — the announced line', () => {
