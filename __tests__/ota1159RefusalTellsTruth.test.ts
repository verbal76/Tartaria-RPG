// OTA-1159 — THE CONTRACT REFUSAL STOPS BLAMING TRAVEL.
//
// The LAST of the four design calls OTA-1156 held. The vendor's empty-list line was:
//
...
// one thing that provably cannot help. Same defect class as OTA-1158's help text,
...
describe('OTA-1159 — the refusal names the real reason', () => {
...
describe('OTA-1159 — repLockedFactionQuests answers the question honestly', () => {
...
describe('OTA-1159 — the shape of the gating, pinned', () => {
