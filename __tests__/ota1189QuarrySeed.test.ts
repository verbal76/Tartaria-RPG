...
// meet nobody. OTA-1188 answered that by widening the DEADLINE, which bought time to keep
...
describe('OTA-1189 — where the groups are placed', () => {
...
describe('OTA-1189 — the arrival beat', () => {
...
describe('OTA-1189 — seeding on arrival', () => {
  const BOUNTY = {
...
describe('OTA-1189 — it is wired everywhere a player can arrive', () => {
