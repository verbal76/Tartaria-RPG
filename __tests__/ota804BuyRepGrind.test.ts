// OTA-804 — buying builds faction standing only as a SLOW GRIND (per the user):
...
function setVendor(store: ReturnType<typeof useGameStore>, price: number, stock = 999) {
  store.setState((s) => ({
    ...
    // OTA-1337 — ZERO the ladder (don't wipe the row: the grind writer updates
...
describe('OTA-804 — buy-rep is a slow TC-spent grind', () => {
