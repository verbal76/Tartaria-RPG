...
// OTA-982 — durability rebalance. Owner's log: a freshly crafted 5-piece set
...
describe('OTA-982 — one landed blow chips ONE worn piece, not the set', () => {
...
describe('OTA-982 — armor frays out loud before it shatters', () => {
