...
describe('OTA-1164 — the four states of a bounty course control', () => {
...
describe('OTA-1164 — the store stopped failing in silence', () => {
  beforeEach(async () => {
...
describe('OTA-1164 — accepting a second contract routes when no road is running', () => {
  beforeEach(async () => {
    await useGameStore.getState().hydrate();
...
describe('OTA-1164 — both screens share one state machine', () => {
