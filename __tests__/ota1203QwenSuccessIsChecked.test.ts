// OTA-1203 — A FAILED MODEL LOAD WAS BEING RECORDED AS AN INIT SUCCESS.
//
// ⚠⚠ MEASURED — owner's bug report, 2026-08-09, build `2026-08-09-1202`. The header claims
...
//   · OTA-1201 — `importSaveAsNewSlot` would have announced a character over a slot that
...
describe('OTA-1203 — the premise: bootQwen resolves on failure', () => {
...
describe('OTA-1203 — App.tsx checks the outcome before recording success', () => {
...
describe('OTA-1203 — the report block says whether the model loaded', () => {
  ...
  test('the engine status sits with the context count', () => {
    ...
    // ⚠ RETARGETED BY OTA-1204, which destructured the read to also pull `qwenError`.
