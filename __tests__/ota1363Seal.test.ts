// ⚠⚠ OTA-1363 — THE SEAL: HMAC-SHA256, checked against published vectors.
//
// GOLEM LINE ONLY.
//
...
describe('OTA-1363 — SHA-256 against the published digests', () => {
...
describe('OTA-1363 — HMAC against RFC 4231', () => {
...
describe('OTA-1363 — sealing a payload', () => {
