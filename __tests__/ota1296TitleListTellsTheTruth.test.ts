...
// ⚠⚠ OTA-1296 (port of golem OTA-1294) — THE CHARACTER SELECT WAS A BOOT-TIME SNAPSHOT, AND THE OWNER
// CAUGHT IT EXACTLY:
//
...
describe('OTA-1296 (port of golem OTA-1294) — the title screen re-lists on every appearance', () => {
