...
// OTA-1143 finishes the job for the other four sites.
...
describe('OTA-1143 — a killing blow does not buy the round', () => {
...
describe('OTA-1143 — every killing path routes through the one guard', () => {
