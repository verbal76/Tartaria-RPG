...
describe('OTA-1264 — negation is read', () => {
...
describe('OTA-1264 — negation SCOPE, so the rule cannot eat real commands', () => {
...
describe('OTA-1264 — the corpus contract is untouched', () => {
...
describe('OTA-1264 — a question that names an action asks it', () => {
  const QUESTIONS = [
...
describe('OTA-1264 — the refusal reaches the player, and never reaches Qwen', () => {
