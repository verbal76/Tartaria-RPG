// ⚠ OTA-1342 — THE SIX-LINE STANDING WALL IS ONE LINE NOW.
//
...
//   · an OTA-1341 ladder-tier crossing is ALWAYS named, both directions, with the
...
describe('OTA-1342 — one vague line, named thresholds', () => {
