// OTA-1201 — A CHARACTER YOU CAN GET BACK.
//
...
describe('OTA-1201 — damaged text is caught, and says what to do', () => {
...
describe('OTA-1201 — wrong input is refused in plain language', () => {
...
describe('OTA-1201 — import writes a new slot and never overwrites', () => {
  ...
  // ⚠⚠ OTA-1313 SUPERSEDES THIS TEST'S OLD CLAIM, ON PURPOSE.
  //
...
describe('OTA-1201 — the UI is told when the clipboard is not good enough', () => {
