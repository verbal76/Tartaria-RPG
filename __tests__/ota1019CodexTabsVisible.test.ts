...
describe('OTA-1019 — the codex tab row wraps; nothing hides off-screen', () => {
  ...
  it('all 7 sections are still in the row — FALLEN included', () => {
    // ⚠ OTA-1357 — this lock guards a COUNT, not an ORDER. The row was
    ...
    // OTA-1019 was FALLEN and LORE hidden past the right edge.
    ...
    // (ota1357LoreTabs proves the rendered order by mounting the screen.)
  });
});
