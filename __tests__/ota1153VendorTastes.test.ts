// OTA-1153 — EVERY VENDOR HAS TASTES, AND EVERY TASTE POINTS AT SOMETHING REAL.
//
...
describe('OTA-1153 — every authored taste resolves against the live catalog', () => {
...
describe('OTA-1153 — coverage: nobody falls through to the generic fallback', () => {
...
describe('OTA-1153 — the lookup chain', () => {
...
describe('OTA-1153 — reaction ordering', () => {
...
describe('OTA-1153 — the lists are actually fleshed out', () => {
