// arb-fix (OTA-1107) — buying a recipe from a vendor rerolled/restocked the whole recipe
...
describe('OTA-1107 — vendor recipe menu is stable (no reroll on purchase)', () => {
