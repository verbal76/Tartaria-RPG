...
// OTA-1205 — FIRST-USE CARDS CATCH UP WITH THE FEATURE WAVE. The owner's audit ask:
...
//   3./4. Vendor + Contracts cards gained the OTA-1201 host rules.
...
describe('OTA-1205 — one spelling of "is this a Procedure Text"', () => {
...
describe('OTA-1205 — the Aetheric tab card tells the current truth', () => {
...
describe('OTA-1205 — the refreshed screen cards carry new ids', () => {
...
describe('OTA-1205 — LIVE: the pack tap teaches, same as the typed read', () => {
