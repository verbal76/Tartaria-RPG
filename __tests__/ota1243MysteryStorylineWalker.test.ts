...
// ⚠⚠ OTA-1243 — TEXAS RANGER RIDES THE OTHER TWO STAGE FAMILIES. The hunt
// walker (OTA-1242, "Texas Ranger" / "run Chuck Norris") generalized to
...
//
// ⚠⚠ WHAT ITS FIRST RUN CAUGHT (the OTA-1242 wedge class, third member):
...
describe('OTA-1243 — Texas Ranger on mysteries and storylines: every one completes, in order, on its own verbs', () => {
  beforeAll(async () => {
