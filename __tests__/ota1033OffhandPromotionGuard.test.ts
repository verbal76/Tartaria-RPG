...
// OTA-1033 — ONE KNIFE, TWO HANDS. "attack <enemy> with <weapon>" promotes the
...
describe('OTA-1033 — the off-hand can no longer be promoted into the main hand', () => {
...
describe('OTA-1033 — category lock', () => {
