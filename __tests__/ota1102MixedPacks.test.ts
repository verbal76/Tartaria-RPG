// OTA-1102 — mixed-role packs return, and a pack is scaled as ONE shared budget (not
...
describe('OTA-1102 — mixed-role pack spawning', () => {
...
describe('OTA-1102 — pack scaled as one shared, boss-capped budget', () => {
