...
describe('OTA-1224 / P9 — hand-in is host-specific at owned sites', () => {
...
describe('OTA-1224 / P9 — host gear behind standing (ruling 2)', () => {
  beforeAll(() => { console.log = () => {}; console.warn = () => {}; console.error = () => {}; });
...
describe('OTA-1224 / P9 — the GRAB side is untouched (ruling 1)', () => {
