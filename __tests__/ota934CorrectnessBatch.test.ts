...
// OTA-934 — correctness batch: (1) full weather symmetry — every element resist counters
...
describe('OTA-934 — weather symmetry: any matching resist counters its weather', () => {
...
describe('OTA-934 — applyCoating validates replaceSlot against real capacity', () => {
