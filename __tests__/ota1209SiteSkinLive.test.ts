// OTA-1209 — LIVE PROOF THAT THE SKIN ACTUALLY CHANGES IN PLAY.
//
// ⚠⚠ WHY THIS EXISTS SEPARATELY FROM ota1209SiteSkin. That suite calls
...
describe('OTA-1209 — live: a foreign site reads as its owner', () => {
  ...
  test('⚠ and the broker is still standing in the gate at the foreign site', async () => {
    // OTA-1208's fallback must survive the reskin at the exact place it matters most —
