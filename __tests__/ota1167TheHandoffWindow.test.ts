...
//
// ⚠ WHAT IT IS NOT. It is not OTA-1166: that load was ~90 minutes after the
...
//
// ⚠ WHAT IT IS. Two independent holes, and OTA-1157 closed neither for this
// shape of job:
//
...
describe('OTA-1167 — the reservation holds the slot', () => {
...
describe('OTA-1167 — only lines that need the lock reserve it', () => {
  ...
  it('the reserve is gated on a chunk actually needing synthesis', () => {
    // ⚠ A banked (OTA-1153 pre-synthesised) line plays straight from memory and
