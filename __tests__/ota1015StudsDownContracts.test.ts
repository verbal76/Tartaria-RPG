...
// OTA-1015 — studs-down corrections, batch 2: contracts + toasts.
...
describe('OTA-1015 — single-active is enforced at ACTIVATION', () => {
...
describe('OTA-1015 — the toast category, actually closed', () => {
