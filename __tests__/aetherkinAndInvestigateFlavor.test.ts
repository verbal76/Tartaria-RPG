// OTA-1001 — three glitches a playtest log surfaced:
//
...
describe('OTA-1001 — investigate flavor never treats architecture as handheld', () => {
  // These nouns fall through to the generic category (no dedicated keyword
  // template) AND classify as fixed features.
  // OTA-1004 — includes the nouns the playtest log caught still slipping
...
describe('OTA-1001 — item-use nudge requires a whole-word overlap', () => {
...
describe('OTA-1002 — provoke is data-driven (pulled from the encounter JSON)', () => {
...
describe('OTA-1001 — Aetherkin makes good on the threat', () => {
  beforeAll(() => {
    console.log = () => {};
    console.warn = () => {};
    console.error = () => {};
