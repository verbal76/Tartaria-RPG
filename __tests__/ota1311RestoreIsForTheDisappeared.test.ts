...
// ⚠⚠ OTA-1311 — THE INFINITE LIFE GLITCH.
//
...
// ⚠ OTA-1317 audit — SaveState lives in engine/types and was never re-exported
// by saveSystem; the old import passed Jest only because babel strips types,
...
describe('OTA-1311 — restore is only for a character that disappeared', () => {
