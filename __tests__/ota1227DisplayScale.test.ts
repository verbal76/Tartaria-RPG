...
// ⚠⚠ OTA-1227 — THE PC BUILD STOPS BEING A PHONE ON A MONITOR. Owner, looking
...
describe('OTA-1227 — one column width, and a scale control that only exists where it works', () => {
  ...
  it('⚠ the desktop width is genuinely wider — the whole point of the change', () => {
    // ⚠ OTA-1229 moved the pure constants to ./layoutConstants (displayScale
