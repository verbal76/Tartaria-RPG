...
// ⚠⚠ OTA-1287 (port of golem OTA-1278) — THE WATCHDOG WAS WALKING STRAIGHT THROUGH OTA-1287 (port of golem OTA-1275)'s DEBOUNCE.
//
...
describe('OTA-1287 (port of golem OTA-1278) — one settle window, both doors', () => {
