// OTA-1097 — THE FUSABLE VIEW BECOMES A SELECTION SURFACE.
//
...
describe('OTA-1097 — reserveManyForFusion', () => {
  beforeEach(async () => {
...
describe('OTA-1097 — source locks on the selection surface', () => {
  ...
  // OTA-1100 — SUPERSEDED, deliberately. This OTA's long-press opened the item
  // sheet as an escape hatch from tap-to-toggle. OTA-1100 gave the whole
  ...
  it('the mode says itself out loud, and a reserved row is visibly selected', () => {
    ...
    // OTA-1100 — the role now also covers group mode; the FUSABLE checkbox
