// OTA-801 — group-C polish regressions (pure-engine):
...
describe('OTA-801 C2 — fusedWeaponNameReadsSoft', () => {
...
describe('OTA-801 C2 — the Qwen namer rejects a soft WEAPON name', () => {
...
describe('OTA-801 C2 — migrateFusedName heals a soft-named weapon on load', () => {
