/**
 * WEB-002 — three fixes off the 4.29.260 device log.
 *
 ...
 * The native-queue watch and the door check are locked in web002NativeQueue.
 */
import fs from 'fs';
...
describe('WEB-002 — the buried level is not generic any more', () => {
  ...
  it('each buried room READS differently in every faction (prose, not names)', () => {
    ...
    // It asserted every faction must rename the buried rooms, and the follow-up wave
    ...
    // against the artwork in web003MapNames; what belongs here is the prose,
...
describe('WEB-002 — the new chips do not collide with the old ones', () => {
...
describe('WEB-002 — the salvage line owns its article and its capital', () => {
