...
// OTA-980 — combat truth batch, from one playtest log:
...
describe('OTA-980 — a mid-fight DOT kill lands NOW, not on the next swing', () => {
...
describe('OTA-980 — a bandolier throw settles when its dice modal closes', () => {
...
describe('OTA-980 — point blank follows the hand that swings', () => {
