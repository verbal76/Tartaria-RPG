...
// OTA-951 — Phase B of real heights: PERCHES. Objects tucked partway up taller
...
describe('OTA-951 — perch templates are honest', () => {
...
describe('OTA-951 — deterministic seeding', () => {
  const CLIMBS = [
...
describe('OTA-951 — tier-gated loot roller', () => {
