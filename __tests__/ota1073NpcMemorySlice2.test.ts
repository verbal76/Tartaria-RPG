/**
 * OTA-1073 — Phase 1, slice 2. The four things OTA-1072 deliberately left out:
 *
...
const see = (m: WorldMemory, npc: NpcMet, times = 1, hours = 0) => {
  let out = m;
  // OTA-1078 — one in-game hour per visit: a same-clock sighting is a re-render,
...
describe('OTA-1073 — finishing the work is what counts', () => {
...
describe('OTA-1073 — the people column reports the relationship', () => {
...
describe('OTA-1073 — word travels, but rarely', () => {
