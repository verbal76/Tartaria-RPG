// OTA-1220 — PUNCHLIST P15, MEASURED. The three files under `data/relics`, and what is
...
describe('OTA-1220 / P15 — loot_tables.json: imported, resolving, and (since OTA-1222) READ', () => {
  ...
  test('⚠ but most of those names have no catalog row — they would mint as TROPHIES', () => {
    ...
    // ⚠ 113 → 117 (OTA-1226): the four Procedure Texts joined the table so the site-loot
...
describe('OTA-1220 / P15 — relics.json: mostly SUPERSEDED, six unbuilt names', () => {
...
describe('OTA-1220 / P15 — curios.json is fully wired (the control)', () => {
