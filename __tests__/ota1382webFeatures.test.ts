/**
 * OTA-web10 — Step 3: the intentional differences become ONE config file.
 *
...
describe('OTA-web10 — the product flag', () => {
...
describe('OTA-web10 — platform capability is NOT a flag', () => {
...
describe('OTA-web10 — the migration that was universalised rather than flagged', () => {
...
describe('OTA-web10 — the rule for future differences', () => {
