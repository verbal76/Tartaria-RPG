// ⚠⚠ OTA-1335 — TYPE A DEV NAME AND THE WHOLE MISSION BOARD IS ALREADY OPEN.
//
...
describe('OTA-1335 — the Verbal full board', () => {
  ...
  it('⚠ OTA-1335 spire notice — the load migration leaves a legacy save eligible', () => {
