...
// OTA-1030 — THE POPUP THAT COULDN'T WAIT. The story-thread completion notice
...
//
// OTA-1050 UPDATE — the held popup is retired entirely (owner: redundant next
...
describe('OTA-1030 — the completion popup waits for COMPLETE', () => {
  beforeAll(() => {
    console.log = () => {};
    console.warn = () => {};
    console.error = () => {};
...
describe('OTA-1030 — category lock: terminal stage shows COMPLETE alone', () => {
  ...
  it('the store never announces a story-thread popup at all', () => {
    ...
    expect(store.includes('completionNotice')).toBe(false);                       // OTA-1050: the stash is retired too
