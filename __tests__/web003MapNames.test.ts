/**
 * WEB-003 — the button has to agree with the picture.
 *
...
describe('WEB-003 — names match the painted labels', () => {
...
describe('WEB-003 — the chip is a word off the label', () => {
...
describe('WEB-003 — the arrow leads the chip', () => {
