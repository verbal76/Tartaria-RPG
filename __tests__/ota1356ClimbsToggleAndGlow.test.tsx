// ⚠⚠ OTA-1356 — THE ACTIVE MISSION GLOWS, AND THE TOWERS BEHAVE LIKE MISSIONS.
//
...
// running" flag since OTA-1304, but SET COURSE was the only thing that could
...
// has cleared `routedClimbId` since OTA-1320, but setContractActive's identical
...
// bar since OTA-1175, the five towers alone rendered in fixed catalog order.
...
describe('OTA-1356 — the towers toggle, and the active mission glows', () => {
