...
// OTA-1037 — THE WEDGED CONTRACTS CARD. Owner's report: after accidentally
...
describe('OTA-1037 — cancelling a course stands down the mission route chain', () => {
  beforeAll(() => {
    console.log = () => {};
    console.warn = () => {};
  });
...
describe('OTA-1037 — a refused COMPLETE tap answers on the Contracts screen', () => {
...
describe('OTA-1037 — SOURCE LOCKS (category: course-cancel clears routing; refusals visible on-screen)', () => {
