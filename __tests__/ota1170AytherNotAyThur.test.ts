// OTA-1170 — "ĀTHER", AND THE FAMILY THAT WAS THREE-QUARTERS UNCOVERED.
//
...
describe('OTA-1170 — the head is one word', () => {
...
describe('OTA-1170 — ⚠ anything starting with Aether is covered', () => {
...
describe('OTA-1170 — ⚠ the catch-all must sort LAST', () => {
...
describe('OTA-1170 — it stays inside its own family', () => {
...
describe('OTA-1170 — it composes with the OTA-1169 article rule', () => {
