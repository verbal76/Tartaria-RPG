...
// OTA-1005 — the wedged bandolier (ghost equip references). Racked/stowed ids
...
describe('OTA-1005 — ghosts are swept on load', () => {
...
describe('OTA-1005 — the cap checks count only LIVE ids (mid-session ghosts cannot wedge)', () => {
