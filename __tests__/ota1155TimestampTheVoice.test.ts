...
// OTA-1155 — TIMESTAMP THE VOICE, BECAUSE THE OWNER WAS TIMING IT BY HAND.
//
// After OTA-1153 shipped, still clocking it manually:
//
...
// Plus the SOURCE: cached (OTA-1153 pre-synthesis), prefetch, or live. That
...
describe('OTA-1155 — the sink exists and is safe to leave unset', () => {
...
describe('OTA-1155 — ⚠ the three numbers, and why there are three', () => {
...
describe('OTA-1155 — ⚠ the wiring does not break the mocks', () => {
