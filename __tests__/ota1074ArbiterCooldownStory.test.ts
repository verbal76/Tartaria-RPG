...
/**
 * OTA-1074 — Phase 0, items 3 and 4.
 *
...
describe('OTA-1074 — the story-beat marker', () => {
...
describe('OTA-1074 — the story sites are actually wired', () => {
...
describe('OTA-1074 — ambient staleness', () => {
  // eslint-disable-next-line @typescript-eslint/no-require-imports
  const src: string = require('fs').readFileSync(
    require('path').join(__dirname, '../app/state/gameStore.ts'),
    'utf8',
