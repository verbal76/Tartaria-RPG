/**
 * OTA-1369 — the button has to agree with the picture.
 *
...
describe('OTA-1369 — names match the painted labels', () => {
...
describe('OTA-1369 — the chip is a word off the label', () => {
...
describe('OTA-1369 — the arrow leads the chip', () => {
