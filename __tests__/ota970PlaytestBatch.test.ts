...
// OTA-970 — playtest batch: (1) "attack the arch" mis-bound to "research chart"
...
describe('OTA-970 — word-level ambient noun matching', () => {
...
describe('OTA-970 — Aethercraft fuel picker', () => {
...
describe('OTA-970 — hard-scenery strikes bite back, with snark', () => {
...
describe('OTA-970 — elevated refusal always answers on repeats', () => {
