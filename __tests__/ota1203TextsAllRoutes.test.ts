...
// OTA-1203 — PUNCHLIST P16: all three doors open. Owner: *"push it through all routes,
// three doors makes it accessible even with bad faction standing."*
//
// Door 1 (rapport purchase) shipped in OTA-1195. This OTA opens the other two:
//   Door 2 — FOUND: the four Procedure Texts live in the ladder loot pools of four
//     aether-heavy sites, surfaced by OTA-1199's substitution. Zero standing required —
...
describe('OTA-1203 / P16 — door 2, the texts are FINDABLE with zero standing', () => {
...
describe('OTA-1203 / P16 — the READ path is the one teacher', () => {
...
describe('OTA-1203 / P16 — door 3, the story pays the text', () => {
  beforeAll(() => { console.log = () => {}; console.warn = () => {}; console.error = () => {}; });
  ...
  test('⚠⚠ finishing a mapped storyline HANDS OVER the text alongside the authored reward', async () => {
    ...
    // Stand at the POSTING faction's own site (OTA-1201: hand-in is host-specific now).
    // eslint-disable-next-line @typescript-eslint/no-require-imports
