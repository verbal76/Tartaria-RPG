// ⚠⚠ OTA-1340 — THE "YOU ARE HERE" MARKER RETURNS, AND THE VIEW CAN JUMP TO IT.
//
...
describe('OTA-1340 — the pulsing marker and the ⌖ ME button', () => {
  ...
  it('⚠ OTA-1342 — ⌖ ME glides (timed easing), and the ring stroke is the thin weight', () => {
