...
// OTA-973 — Phase A of the real-heights model (the skeleton). Scene nouns can be
...
describe('OTA-973 — placement lookup honors short forms', () => {
...
describe('OTA-973 — reachability matrix', () => {
...
describe('OTA-973 — engine gates route placed nouns by where they hang', () => {
