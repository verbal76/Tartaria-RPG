...
// OTA-978 — the Crucible forges REACH. Owner: "let's have the crucible add the
...
describe('OTA-978 — name→reach inference', () => {
...
describe('OTA-978 — the forge stamps a reach and names to match', () => {
...
describe('OTA-978 — old saves get the recheck on load', () => {
...
describe('OTA-978 — a fused ranged weapon actually fires from mid range', () => {
