...
// the items needed."
//
// The first sentence is the OTA-1122/1123 gesture again — hold to start, tap to
...
describe('OTA-1125 — the same grip as SELL and DROP', () => {
  ...
  it('⚠ the bar is ANCHORED above the scroll and TAKES REPAIR ALL\'s place', () => {
    // Same structural rule as OTA-1124's sell bar: it sits outside the
...
describe('OTA-1125 — the running material budget', () => {
  ...
  it('⚠ a dimmed row says WHY, and says the RIGHT why', () => {
    // "Greyed out" with no reason is the silent-rule failure OTA-1117 was
...
describe('OTA-1125 — the simulation the screen runs is the one the engine honours', () => {
