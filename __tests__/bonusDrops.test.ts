// OTA-1006 — a Fallout-4-ish sprinkle of GOOD crafting materials on top of
...
describe('OTA-1006 — isHardWonFight', () => {
...
describe('OTA-1006 — rollBonusMaterial tiers', () => {
...
describe('OTA-1006 — maybeCombatBonus (additive, hard-won only)', () => {
...
describe('OTA-1006 — maybeLoreHookBonus', () => {
...
describe('OTA-1006 — cadence is a sprinkle, not every fight', () => {
