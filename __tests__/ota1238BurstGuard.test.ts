...
// OTA-1238 — THE BURST GUARD. The owner's device, within an hour of OTA-1236
...
describe("OTA-1238 — the owner's three-chip burst advances exactly ONE stage", () => {
  ...
  it('⚠⚠ an un-awaited INVESTIGATE ALL burst cannot double-fire a stage', async () => {
    ...
    // The device repro: the OTA-1206 INVESTIGATE ALL loop — one submit per
