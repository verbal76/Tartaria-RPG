...
/**
 * OTA-1057 — THE REST OF THE CAST GOES ON THE LEDGER.
 *
 ...
 *    leak of OTA-1053 waiting to happen again in a system that had never been
...
describe('OTA-1057 — a wanderer is a person, on any tile', () => {
  it('THE LEAK THAT NEVER GOT THE CHANCE: the tile seed does not split them', () => {
    ...
    // OTA-1053 all over again — an unbounded row per encounter.
  ...
  it('SHAKING THEM DOWN IS A WRONG — it used to be the one free robbery', () => {
    ...
    // OTA-1049. Putting a hand on a traveller and taking their coins cost
...
describe('OTA-1057 — an escort party has somebody at the front', () => {
  ...
  it('a pre-OTA-1057 save with no leader does not crash the party', () => {
...
describe('OTA-1057 — the identity rule keeps its old promises', () => {
