// OTA-1177 — COUNT THE LIVE MODEL CONTEXTS. AN INSTRUMENT, SHIPPED ALONE, ON PURPOSE.
//
...
// day of building on inference: **measure the cause, or ship an instrument.** OTA-1172
// wrote that rule into its own source; OTA-1173 overrode it with a well-argued paragraph
...
describe('OTA-1177 — the ledger arithmetic', () => {
...
describe('OTA-1177 — the summary block', () => {
  ...
  test('the bug report includes the block, and behind its own guard', () => {
    ...
    // ⚠ Widened by OTA-1180, which added the narration-engine line inside this block.
    // FOURTH fixed-size source slice to age this session (ota1172 / ota1173 / ota1175 / ota1177) — the
...
describe('OTA-1177 — a real LlamaRuntime, driven', () => {
...
describe('OTA-1177 — the instrument cannot break its host', () => {
