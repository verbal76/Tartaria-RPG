// OTA-1211 — PUNCHLIST P3. The courier is back, for REPORTS only.
//
...
describe('OTA-1211 — what the courier costs', () => {
...
describe('⚠⚠ OTA-1211 — the hours are charged UP FRONT, not deferred', () => {
...
describe('⚠⚠ OTA-1211 — what it may and may not carry', () => {
...
describe('⚠ OTA-1211 — a courier turn-in credits nobody', () => {
  test('the flag reaches creditTurnIn in both report handlers', () => {
    // OTA-1073's own comment names this hazard: a courier hand-in can happen while the
...
describe('⚠ OTA-1211 — no reward line claims a bonus the courier did not pay', () => {
