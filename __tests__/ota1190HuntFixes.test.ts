// OTA-1190 — THE HUNT SEES YOUR GEAR, AND WON'T ROUTE A CONTRACT THAT ISN'T RUNNING.
//
...
describe('OTA-1190 — the report, corrected against the data', () => {
...
describe('OTA-1190 — the boss finally reads the whole character', () => {
...
describe('OTA-1190 — two lines that were lying about the clock', () => {
  ...
  it('⚠ THE COURSE BANNER CALLED EVERY TILE "A DAY"', () => {
    ...
    // 0.25h on the clock and ~2.5h all-in (OTA-1185) — this was the last surface still
...
describe('OTA-1190 — a paused contract will not route you', () => {
  it('⚠ ROUTE USED TO IGNORE `tracked` ENTIRELY', () => {
    // The card said "⏸ PAUSED" two rows up while the button beneath it offered to walk
    // you there. Same defect family as OTA-1187: a control acting without the state that
    // gives it meaning.
