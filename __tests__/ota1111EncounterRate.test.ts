// OTA-1111 — HALF. Owner: "there were sections that every move or rest was a
...
describe('OTA-1111 — the encounter roll is halved', () => {
...
describe('OTA-1111 — what was deliberately left alone', () => {
  ...
  it('the change is DOCUMENTED at the constant, including why not a ramp', () => {
    const near = store.slice(store.indexOf('OTA-1111'), store.indexOf(ROLL_LINE));
