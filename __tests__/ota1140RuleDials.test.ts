// OTA-1140 — THE RULE DIALS, AND ONE THAT WAS A CONTROL OVER NOTHING.
//
// OTA-1136 defined nine dials; OTA-1139 wired the content one. This closes the
...
describe('OTA-1140 — the two rule dials still obey the identity row', () => {
...
describe('OTA-1140 — witholdIntel takes the FREE read, never the earned one', () => {
...
describe('OTA-1140 — witholdIdentity stops the free enrichment, not the item', () => {
...
describe('OTA-1140 — ⚠ the hunger dial is gone, and the file says why', () => {
...
describe('OTA-1140 — every remaining dial has a consumer', () => {
  it('⚠ the picker offers nothing that cannot change a number', () => {
    ...
    // ⚠ OTA-1194 STRENGTHENED THIS. The list above was BOOKKEEPING — it proved a dial had
