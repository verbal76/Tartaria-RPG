...
// OTA-1006 — THE GREEN LIE. The weapon quick-buttons and the enemy panel kept
...
describe('OTA-1006 — one reach resolver for the gate AND the highlight', () => {
...
describe('OTA-1006 — category lock: no local reach derivations in the UI', () => {
