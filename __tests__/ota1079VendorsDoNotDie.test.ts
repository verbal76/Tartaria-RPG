...
describe('OTA-1079 — beating a trader does not kill them', () => {
...
describe('OTA-1079 — they keep every last thing', () => {
...
describe('OTA-1079 — the room turns you out', () => {
...
describe('OTA-1079 — it costs you, on both ledgers', () => {
  ...
  it('and it goes on THEIR ledger as a wrong — so it is visible, and payable', async () => {
    ...
    // permanent black mark: OTA-1076's amends give a road back.
