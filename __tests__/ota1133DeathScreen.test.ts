// OTA-1133 — THE DEATH SCREEN, AND THE LOCKDOWN AT ZERO.
//
...
//
// THE SCREEN. The opening crawl (OTA-1041) asks why you came down and offers
...
describe('OTA-1133 — the ending is written from the same motive as the opening', () => {
...
describe('OTA-1133 — the screen crossfades, holds, and leaves on its own', () => {
  ...
  it('⚠ it hands over to the character collection WITHOUT being touched', () => {
    ...
    // RETARGETED BY OTA-1142 — 11s → 16s on the owner's call: "increase the
...
describe('OTA-1133 — nothing happens after zero', () => {
  ...
  it('the check reads LIVE state, never a snapshot', () => {
    ...
    // killing blow (cf. OTA-969, OTA-1126).
