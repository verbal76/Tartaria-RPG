...
// OTA-1145 — THE BANK. Step two of the LLM headroom track.
//
...
describe('OTA-1145 — a banked musing is spent when it still fits', () => {
...
describe('OTA-1145 — the bank stays small and honest', () => {
...
describe('OTA-1145 — the wiring, and the rules it must not break', () => {
  ...
  it('the fill path never speaks', () => {
    ...
    // ⚠ RETARGETED BY OTA-1152 — by the SAME failure mode the comment above
    ...
    // `if (opts?.bankOnly) {`, and OTA-1152 gave narrateViaArbiter a bankOnly
