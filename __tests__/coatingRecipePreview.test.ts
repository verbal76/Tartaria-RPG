// OTA-1012 — the RECIPES tab splits FOOD & HEALTH from WEAPON COATINGS (coatings
...
describe('OTA-1012 — coatings split out of food', () => {
...
describe('OTA-1012 — coating output is legible on the recipe card', () => {
