 ...
 *
 * OTA-1046 fixed the storm family and flagged three more as still cheap. Owner:
 * "fix the other three."
 *
...
describe('OTA-1047 — scion_of_the_giants must be PROVEN, not just born', () => {
...
describe('OTA-1047 — golem_whisperer requires the golem to have fought', () => {
...
describe('OTA-1047 — architects_eye takes a body of work', () => {
...
describe('OTA-1047 — nothing is earnable at character creation any more', () => {
  it('a fresh Giant with zero deeds has earned NOTHING at all', () => {
    // OTA-1046 proved this for the counter-driven titles but had to exclude the
