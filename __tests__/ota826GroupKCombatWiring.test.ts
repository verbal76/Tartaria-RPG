// OTA-1111 [Group-K audit] — player↔enemy damage-type wiring. The audit found
...
it('OTA-1111 (1) — a coated throwable thrown by name seeds a lingering DOT on the surviving enemy', async () => {
...
it('OTA-1111 (2) — burst fire applies the damage-type weakness (tags a weak hit in the log)', async () => {
