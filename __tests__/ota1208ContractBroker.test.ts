// OTA-1208 — PUNCHLIST P2 CLOSED. The trading post takes any faction's contract for a cut.
//
...
describe('OTA-1208 — who the broker is', () => {
...
describe('OTA-1208 — who may take a contract', () => {
...
describe('⚠⚠ OTA-1208 — every turn-in path routes through the ONE resolver', () => {
  ...
  test('⚠⚠ no reward line claims a long-haul bonus the broker did not pay', () => {
    // OTA-1179 shipped because a line stated an outcome nobody had checked. The same
...
describe('⚠⚠ OTA-1208 — the broker DOES take deliveries, and this suite is why', () => {
  const STORE = SRC('app/state/gameStore.ts');
