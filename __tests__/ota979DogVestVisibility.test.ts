...
// OTA-979 — dog-vest equipped visibility. Owner: "dog vests don't show which
...
describe('OTA-979 — wornDogVestInstanceId resolves the exact worn vest', () => {
...
describe('OTA-979 — a settled Crucible rename follows onto the dog', () => {
