...
describe('OTA-1360 — the shared roll of the fallen: the door', () => {
...
describe('OTA-1360 — the gear allowlist', () => {
  it('⚠⚠ THE ATTACK: a golemCore, fused stats, and a quest lock are all stripped', () => {
    ...
    // ⚠ OTA-1360 — coatings and fused stats now CROSS (the owner's call: the
...
describe('OTA-1360 — the merge rules', () => {
...
describe('OTA-1360 — rest records and the wire envelope', () => {
...
describe('OTA-1360 — the lineage name', () => {
...
describe('OTA-1360 — the lore of the Hollowed', () => {
...
// ⚠⚠ OTA-1360 — THE UPGRADES TRAVEL, AND ARRIVE LEGAL.
//
...
describe('OTA-1360 — a dead player\'s upgrade work crosses, clamped', () => {
  const upgraded = {
...
// ⚠⚠ OTA-1360 — THE CLONE. Owner: *"what I want is the exact same in every
...
describe('OTA-1360 — the clone crosses whole', () => {
  const SNAP = {
