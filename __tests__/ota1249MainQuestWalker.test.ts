...
// ⚠⚠ OTA-1249 — TEXAS RANGER WALKS THE MAIN QUEST. The last unwalked road, and
...
// once. The ending suites (ota1248) start from a SEEDED choice phase: they
...
//     AND the Reckoning (OTA-1248) in the feed
...
//
// ⚠⚠ HARNESS TRAPS: the five in the ota1242HuntWalker header apply, plus:
...
/** Conduct that reaches the Arbiter's kin band, seeded the way the OTA-1248
...
describe('OTA-1249 — the main quest walker: creation to credits, nine factions, four endings', () => {
