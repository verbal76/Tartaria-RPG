// OTA-1090 — Charisma-scaled vendor pricing, gated per faction by a rapport quest.
...
describe('OTA-1090 — rapport pricing helpers', () => {
...
describe('OTA-1090 — buy discount is gated + CHA-scaled', () => {
