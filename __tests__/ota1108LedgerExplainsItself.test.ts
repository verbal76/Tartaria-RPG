...
/**
 * OTA-1108 — THE LEDGER EXPLAINS ITSELF.
 *
...
describe('OTA-1108 — every judged answer is its own named row', () => {
...
describe('OTA-1108 — SOURCE LOCKS: one corpse, one ledger line', () => {
