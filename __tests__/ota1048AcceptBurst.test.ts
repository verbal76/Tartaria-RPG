...
describe('OTA-1048 — the first accept of a burst is narrated in full', () => {
...
describe('OTA-1048 — everything after it collapses to one line', () => {
...
describe('OTA-1048 — the reported case: thirteen contracts at one board', () => {
...
describe('OTA-1048 — the burst has to actually end for detail to return', () => {
