...
describe('OTA-1109 — the mud-golem hook spawns the monster it narrated', () => {
...
describe("OTA-1109 — 'accept X' hints never collide at one counter", () => {
...
describe('OTA-1109 — the Crucible refuses input-echo and curio names', () => {
...
describe('OTA-1109 — the raid is told once, not on every room-hop', () => {
...
describe('OTA-1109 — recent encounters stay off the table', () => {
...
describe('OTA-1109 — the visible sneak roll is THE sneak roll', () => {
