// OTA-1185 — ONE PRICE FOR A TILE, AND A DEADLINE DERIVED FROM IT.
//
...
describe('OTA-1185 — a tile costs one thing, however you ask for it', () => {
...
describe('OTA-1185 — 2.5 is a conversion factor, and it is derived', () => {
...
describe('OTA-1185 — the deadline is the journey', () => {
