// OTA-1195 — LIVE PROOF FOR P16. A player buys a procedure, channels it, and something
...
describe('OTA-1195 / P16 — a technique is reachable', () => {
...
describe('OTA-1195 / P16 — buying the procedure', () => {
  beforeAll(() => { console.log = () => {}; console.warn = () => {}; console.error = () => {}; });

  test('⚠⚠ a rapport vendor stocks the text, and buying it TEACHES the technique', async () => {
    // ⚠ THE WORKSHOP, NOT THE GATE. Halem is factionless on purpose (OTA-1185 made him the
...
describe('OTA-1195 / P16 — in a fight', () => {
  beforeAll(() => { console.log = () => {}; console.warn = () => {}; console.error = () => {}; });
  ...
  test('⚠⚠ channelling COSTS THE TURN — the enemy group answers', async () => {
    ...
    // arrival's combat line answer for this one — the OTA-1186 mistake.
