...
// OTA-1032 re-voiced the rest ambush for INDOOR scenes and gave that path
...
describe('OTA-1112 — the outdoor rest ambush stops repeating itself', () => {
  ...
  it('⚠ the outdoor lines stay OUTDOOR — no sealed-room images', () => {
    // OTA-1032's whole point was that the two situations need different
...
describe('OTA-1112 — wired at the one site that had the hardcoded string', () => {
