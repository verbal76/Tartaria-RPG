// OTA-1174 — THE CONVERSATION REMEMBERS, and the question was never written down.
//
...
//      window on gameLog (OTA-1118) that closes with the conversation, and
...
describe('OTA-1174 — the question is written down', () => {
...
describe('OTA-1174 — the exchange survives the conversation closing', () => {
