// OTA-1056 — RAIDERS, SOLDIERS AND AETHERKIN CAN ALL COME INSIDE. Owner: "make
...
describe('OTA-1056 — the three groups the owner named are all in', () => {
...
describe('OTA-1056 — a faction raider/soldier wears a human body', () => {
...
describe('OTA-1056 — SOURCE LOCKS', () => {
