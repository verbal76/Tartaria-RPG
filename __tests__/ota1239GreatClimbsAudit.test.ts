// OTA-1239 — THE MAP TOWERS JOIN THE EVERY-STAGE-HAS-A-TRIGGER LAW. Owner,
...
// This suite walks every link of that chain the same way ota1236/1237 walk the
...
describe('OTA-1239 — every tower is reachable, climbable, and pays', () => {
