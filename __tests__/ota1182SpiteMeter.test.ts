...
describe('OTA-1182 — the spite farm is bounded', () => {
  ...
  it('a partial gain lands partially, and the excess is rolled OFF the rows', () => {
    ...
    // the OTA-1179 defect — a log that disagrees with the save — pointing the other
...
describe('OTA-1182 — wired where the hostile acts are', () => {
