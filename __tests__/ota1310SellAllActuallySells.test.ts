...
// ⚠⚠ OTA-1310 — THE CONFIRM HAD NO CONFIRM BUTTON.
//
// The feature ARRIVES on this line whole (owner: *"add the bulk sell to Hal I
// approve"*). On golem it shipped with a title, a body and no button, and the
// owner found it by tapping a dull OK that sold nothing: *"I hit OK which okay
// should have a highlighted outline not the dull one that it has. but even when
// I hit it it just takes me back to the same menu. doesn't sell anything."*
// These tests exist so that hole is not dug a second time here.
//
...
// bulkSellCommonGear branch since OTA-1310. It was simply unreachable. A title
...
describe('OTA-1310 — sell-all-common actually sells', () => {
