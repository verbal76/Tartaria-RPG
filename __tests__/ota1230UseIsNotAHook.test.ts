...
// OTA-1230 — TWO DEFECTS OFF THE 2026-08-10 DEVICE LOG (Pixel, OTA-1229 live).
//
...
//    about a locket that never existed (the OTA-1181 class: text promising what
//    code doesn't grant).
...
describe('OTA-1230 — using a carried item is not hook engagement', () => {
...
describe('OTA-1230 — a rolled-loot lore_note may not narrate one specific roll', () => {
