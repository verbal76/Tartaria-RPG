// OTA-1177 — GIFT MODE, AND THE LIST THAT USED TO OFFER WHAT IT WOULD REFUSE.
//
...
describe('OTA-1177 — what may never be given away', () => {
...
describe('OTA-1177 — category lock: one predicate, not two', () => {
  const fs = require('fs');
...
describe('OTA-1177 — everyone who can receive a gift can be offered one', () => {
  const fs = require('fs');
  const path = require('path');
