...
// OTA-1043 — CHAPTER CARDS (story feature, phase 2). Owner: "we need to keep
...
describe('OTA-1043 — the authored chapter content is complete', () => {
  ...
  it('⚠⚠ OTA-1334 — the cards that fire over a guardian kill open with VICTORY; the others must not', () => {
...
describe('OTA-1043 — the arc raises cards through the store', () => {
...
describe('OTA-1043 — SOURCE LOCKS (category: the cards reach the screen)', () => {
