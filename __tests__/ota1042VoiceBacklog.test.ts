/**
 * OTA-1042 — the tutorial voice ran a beat behind the screen.
 *
...
describe('OTA-1042 — a superseding line collapses the voice backlog', () => {
...
describe('OTA-1042 — every tutorial beat instruction is tagged to supersede', () => {
