...
// OTA-1040 — INITIATIVE FINALLY DECIDES THE ORDER. Owner: "I thought the
...
describe('OTA-1040 — losing initiative means they swing first', () => {
...
describe('OTA-1040 — only the Hardened Climbing Strap anchors a rest', () => {
  ...
  it('SOURCE LOCK: initiative is wired to the volley, and every post-strike site is guarded', () => {
    ...
    // All five post-strike volley sites: dodged, SLIPPED (OTA-1225 — an enemy's held
