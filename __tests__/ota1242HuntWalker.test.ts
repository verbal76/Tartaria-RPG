...
// ⚠⚠ OTA-1242 — THE HUNT WALKER. Owner: "since you keep finding errors when you
...
// stages (OTA-871) but hunts never got that loop, and the OTA-1236 verb
...
//  4. SCENE RESETS: the attack rows advance OUT of combat only (OTA-1240), so
...
describe('OTA-1242 — the hunt walker: every hunt in the catalog completes, in order, on its own verbs', () => {
  beforeAll(async () => {
