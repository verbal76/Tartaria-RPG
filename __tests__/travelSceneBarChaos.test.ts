...
describe('travel + scene-bar truthfulness chaos (OTA-126 / OTA-127)', () => {
  ...
  it('⚠ OTA-1347 — a free step RECOMPUTES the area label; it is never stale', async () => {
    // This used to pin the old contract (not-in-transit → clear the label), which
    // is the exact branch OTA-1347 removed: the owner walked six free tiles east
    ...
    // OTA-1348 — the fresh label is tiered now: an Outskirts ring, a road name,
