/**
 * OTA-1378 — a cleared room stays cleared; the one item stops coming back.
 *
...
describe('OTA-1378 — the defect, reproduced', () => {
...
describe('OTA-1378 — the fix: the mask becomes permanent', () => {
...
describe('OTA-1378 — what was NOT touched', () => {
