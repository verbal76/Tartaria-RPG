/**
 * OTA-1367 — a cleared room stays cleared; the one item stops coming back.
 *
...
describe('OTA-1367 — the defect, reproduced', () => {
...
describe('OTA-1367 — the fix: the mask becomes permanent', () => {
...
describe('OTA-1367 — what was NOT touched', () => {
