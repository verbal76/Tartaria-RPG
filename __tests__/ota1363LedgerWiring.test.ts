// ⚠⚠ OTA-1363 — THE SHARED ROLL OF THE FALLEN: the wiring.
//
// GOLEM LINE ONLY. The validator + merge rules are locked in
// ota1363FallenLedger; this suite covers everything that connects them to the
...
describe('OTA-1363 — identity and the house', () => {
...
describe('OTA-1363 — the exchange', () => {
...
describe('OTA-1363 — the spawner join', () => {
...
describe('OTA-1363 — the store wiring, locked at the source', () => {
...
describe('OTA-1363 — the handshake', () => {
