...
describe('OTA-1233 — a lead no chip covers still gets its mark', () => {
...
describe('OTA-1233 — LIVE: charging a lead leaves a mark the chips can show', () => {
...
describe('OTA-1233 — the chips and the count both know about eye-only nouns', () => {
