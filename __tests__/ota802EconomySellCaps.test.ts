// OTA-1087 (B1) — economy re-tiering sell caps (pure-engine):
...
describe('OTA-1087 (b) — bottleneck crafting materials sell near-worthless', () => {
...
describe('OTA-1087 (c) — sell-back never exceeds the cheapest buy (arbitrage floor)', () => {
...
describe('OTA-1087 (a) — self-crafted items cap at ingredient value', () => {
