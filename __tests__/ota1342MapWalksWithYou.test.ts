// ⚠⚠ OTA-1342 — THE MAP WALKS WITH YOU, COURSE OR NO COURSE.
//
// Owner's device log, first session with the OTA-1339 marker: six taps EAST from
...
describe('OTA-1342 — the marker and the bar follow a free walk', () => {
  it('⚠⚠ playerGridCell advances with every free step — the marker anchor moves', async () => {
    ...
    // the OTA-1339 anchor. The marker reads playerGridCell, so it has moved.
