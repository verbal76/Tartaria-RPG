...
// OTA-1050 — DOG + GOLEM NAMING POPUPS, and no second story-hook popup.
...
describe('OTA-1050 — typed input is never an onboarding answer', () => {
...
describe('OTA-1050 — story-hook COMPLETE raises no second popup', () => {
...
describe('OTA-1050 — SOURCE LOCKS', () => {
