...
// OTA-1154 — THE ARBITER STOPS RAMBLING, AND THE PROMPT STOPS LEAKING.
//
// Both findings come from ONE device log (build 4.29.62 / OTA-1152), and both
...
// — recited back and continued from. OTA-1053 built `looksLikeInstructionEcho`
...
//
// Guarded on the literal strings the prompt emits, per OTA-1148's standing
...
describe('OTA-1154 — ⚠ the exact line from the log is caught now', () => {
  ...
  it('⚠ and real narration is NOT eaten — the OTA-1054 lesson', () => {
...
describe('OTA-1154 — ⚠ one unsolicited aside per tile, on a shared clock', () => {
...
describe('OTA-1154 — ⚠ the clock is shared by every Arbiter line', () => {
