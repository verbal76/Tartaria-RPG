/**
 * OTA-1366 — crash reporting, staged: capture now, delivery when there is a DSN.
 *
...
describe('OTA-1366 — the ledger keeps more than one', () => {
...
describe('OTA-1366 — the native death finally becomes a crash', () => {
...
describe('OTA-1366 — both JS capture points write the ledger', () => {
...
describe('OTA-1366 — delivery is inert, and needs BOTH switches', () => {
...
describe('OTA-1366 — it reaches the places a human actually looks', () => {
...
describe('OTA-1366 — what was already here and was NOT replaced', () => {
