/**
 * OTA-1360 — the button has to agree with the picture.
 *
...
describe('OTA-1360 — names match the painted labels', () => {
...
describe('OTA-1360 — the chip is a word off the label', () => {
...
describe('OTA-1360 — the arrow leads the chip', () => {
