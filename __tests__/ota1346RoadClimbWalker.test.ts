// ⚠ OTA-1346 — PUNCHLIST-BRAVO B11: ONE CLIMB WALKER MAKES THE REAL JOURNEY.
//
...
// from a distance (through the OTA-1345 gate confirm, since the character
...
describe('OTA-1346 — a great climb reached by road, not by teleport', () => {
  it('⚠⚠ route Thametan\'s Tower from the outpost, walk every tile, find the GREAT climb standing', async () => {
    ...
    // Route through the OTA-1345 gate confirm if we start inside; otherwise route directly.
