// OTA-1110 — exploit close (reverify workflow, CONFIRMED high-severity). Fusion is
...
describe('OTA-1110 — a SELF-CRAFTED fused piece can no longer be scrapped for premium mats', () => {
...
describe('OTA-1110 — LEGACY fused items (no selfCrafted flag) keep the old full yield', () => {
