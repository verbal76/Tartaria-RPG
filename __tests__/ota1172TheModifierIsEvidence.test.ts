// OTA-1172 — THE MODIFIER IS EVIDENCE, and the head-noun passes were binning it.
//
// Device log, OTA-1166, 20:56:02 and earlier:
...
describe('OTA-1172 — the reported case', () => {
...
describe('OTA-1172 — the modifier now picks between same-noun rows', () => {
...
describe('OTA-1172 — ⚠ what must NOT change', () => {
