/**
 * OTA-1361 — three fixes off the 4.29.260 device log.
 *
 ...
 * The native-queue watch and the door check are locked in ota1361NativeQueue.
 */
import fs from 'fs';
...
describe('OTA-1361 — the buried level is not generic any more', () => {
  ...
  it('each buried room READS differently in every faction (prose, not names)', () => {
    ...
    // It asserted every faction must rename the buried rooms, and the follow-up OTA
    ...
    // against the artwork in ota1361MapNames; what belongs here is the prose,
...
describe('OTA-1361 — the new chips do not collide with the old ones', () => {
...
describe('OTA-1361 — the salvage line owns its article and its capital', () => {
