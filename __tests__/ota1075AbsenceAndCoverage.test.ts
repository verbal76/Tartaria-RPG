 ...
 * Of the three recordNpcMet sites, OTA-1072 paired only the vendor arrival with
...
describe('OTA-1075 — the absence line in the order the store actually calls it', () => {
  ...
  it('a migrated pre-OTA-1072 save anchors on the hours it DID record', () => {
...
describe('OTA-1075 — everyone you meet is on the ledger', () => {
  ...
  it('every NpcMet the store records goes through the paired helper', () => {
    ...
    // OTA-1080 — FOUR now: sightVendor (all five vendor-install paths funnel
