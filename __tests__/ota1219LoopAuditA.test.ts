// OTA-1219 — LOOP AUDIT, BATCH 1. Owner: *"audit this for traced and make sure the loops
// are functional."*
//
...
describe('LOOP 27 — gifting: a gift lands on the ledger and changes the relationship', () => {
  ...
  test('⚠⚠ give → the item leaves, the NPC remembers, and the taste is learned', async () => {
    ...
    // an unmet recipient by design (OTA-1087: no row, no gift), so hand-forging a relation
  ...
  test('⚠ and an UNMET recipient is refused, keeping the item — the OTA-1087 guard, live', async () => {
    ...
    // ends-in-nothing defect OTA-1087 was written for.
