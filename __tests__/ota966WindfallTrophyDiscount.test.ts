// OTA-966 — v2 audit knobs 1 + 2: mid-tier windfalls closed, trophy sell discount.
...
describe('OTA-966 — no sub-Legendary enemy drops a Legendary material (windfalls closed)', () => {
...
describe('OTA-966 — trophy sell discount (half a real material of the same rarity)', () => {
