// OTA-808 — Parley (two-button social) + hard lock-and-key + Menace loop.
...
describe('OTA-808 — parley helpers (lock-and-key)', () => {
...
describe('OTA-808 — parley in the store', () => {
