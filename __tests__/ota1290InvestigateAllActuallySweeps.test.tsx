...
// ⚠⚠ OTA-1290 (port of golem OTA-1268) — INVESTIGATE ALL WAS RESOLVING EXACTLY ONE NOUN, AND THE TEST
...
// golem ota1263 asserted `setTimeout(step, INVESTIGATE_ALL_GAP_MS)` exists and the
...
describe('OTA-1290 (port of golem OTA-1268) — INVESTIGATE ALL, run for real', () => {
  beforeAll(async () => {
