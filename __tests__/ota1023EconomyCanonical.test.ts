// OTA-1023 — the economy reads canonical values (snapshot-audit batch C).
...
describe('OTA-1023 — stale and fresh copies of the same item price identically', () => {
...
describe('OTA-1023 — scrap and repair agree between stale and fresh copies', () => {
...
describe('OTA-1023 — golem feeding and coating drinks read canonical values', () => {
...
describe('OTA-1023 — provenance stamps stay instance-read (design lock)', () => {
