// OTA-1169 — "THE" IS TWO WORDS, and Kokoro only ever said one of them.
//
...
describe('OTA-1169 — the consonant-sound article becomes "thuh"', () => {
...
describe('OTA-1169 — the vowel-sound article stays "thee"', () => {
...
describe('OTA-1169 — ⚠ the two traps a letter test gets backwards', () => {
...
describe('OTA-1169 — it does not touch anything else', () => {
