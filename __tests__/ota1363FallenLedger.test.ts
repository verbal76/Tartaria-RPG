// ⚠⚠ OTA-1363 — THE SHARED ROLL OF THE FALLEN: validator + merge rules.
//
...
describe('OTA-1363 — the shared roll of the fallen: the door', () => {
...
describe('OTA-1363 — the gear allowlist', () => {
...
describe('OTA-1363 — the merge rules', () => {
...
describe('OTA-1363 — rest records and the wire envelope', () => {
...
describe('OTA-1363 — the lineage name', () => {
...
describe('OTA-1363 — the lore of the Hollowed', () => {
