...
// OTA-1222 — LIVE: the app actually HANDS the roller this place's loot table.
//
// ⚠⚠ THIS SUITE EXISTS BECAUSE THE UNIT TESTS CANNOT CATCH A NO-OP. `ota1222SiteLoot`
...
// precisely nothing with eight green tests behind it. That is the OTA-1209 lesson, and it
...
describe('OTA-1222 / P15 — LIVE, the store hands the roller the site table', () => {
