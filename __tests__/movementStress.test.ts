...
const REFUSAL_PATTERNS: RegExp[] = [
  ...
  // OTA-1353 — the rest-in-combat refusal (OTA-1140/OTA-1352). B15's wedge
...
describe('movementStress — cardinal travel + approach quick-action', () => {
  ...
  it('drives 180 in-game days of movement + approach actions', async () => {
    ...
    // OTA-1353 — B15's blind spot, instrumented. A submit that yields NO
    ...
    const submit = (
      ...
      // OTA-1353 — the anti-wedge tripwire. No response line AND no state
    ...
    while (actions < MAX_ACTIONS) {
      ...
      // ⚠ OTA-1353 — B15 CLOSED: ENEMIES BEFORE STAMINA. The old order
      ...
      // refusal regex, and (pre-OTA-1352) swallowed by the arbiter dedup
