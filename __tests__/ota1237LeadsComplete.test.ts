...
// OTA-1237 — EVERY LEAD CAN COMPLETE. The owner's follow-up to the hunt fix —
...
describe('OTA-1237 — the audit: no lead verb without a trigger', () => {
...
describe('OTA-1237 — LIVE: a lead completes at its own site', () => {
