// ⚠ OTA-1351 — PUNCHLIST-BRAVO B11: ONE CLIMB WALKER MAKES THE REAL JOURNEY.
//
...
// from a distance (through the OTA-1350 gate confirm, since the character
...
describe('OTA-1351 — a great climb reached by road, not by teleport', () => {
  it('⚠⚠ route Thametan\'s Tower from the outpost, walk every tile, find the GREAT climb standing', async () => {
    ...
    // Route through the OTA-1350 gate confirm if we start inside; otherwise route directly.
