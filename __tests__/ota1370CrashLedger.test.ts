/**
 * OTA-1370 — crash reporting, staged: capture now, delivery when there is a DSN.
 *
...
describe('OTA-1370 — the ledger keeps more than one', () => {
...
describe('OTA-1370 — the native death finally becomes a crash', () => {
...
describe('OTA-1370 — both JS capture points write the ledger', () => {
...
describe('OTA-1370 — delivery is inert, and needs BOTH switches', () => {
...
describe('OTA-1370 — it reaches the places a human actually looks', () => {
...
describe('OTA-1370 — what was already here and was NOT replaced', () => {
