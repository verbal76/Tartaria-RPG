/**
 * OTA-1366 — Step 3: the intentional differences become ONE config file.
 *
...
describe('OTA-1366 — the product flag', () => {
...
describe('OTA-1366 — platform capability is NOT a flag', () => {
...
describe('OTA-1366 — the migration that was universalised rather than flagged', () => {
...
describe('OTA-1366 — the rule for future differences', () => {
