...
describe('OTA-1066 — four tiers, and the names the owner picked', () => {
...
describe('OTA-1066 — ⚠ lower only, ever', () => {
...
describe('OTA-1066 — ⚠ the lowest tier is genuinely off', () => {
...
describe('OTA-1066 — ⚠ every dial has a ceiling', () => {
...
describe('OTA-1066 — the tide is legible', () => {
...
describe('OTA-1066 — in the real store', () => {
  ...
  it('the hostile-ground gate exempts a bounty you took on purpose', () => {
    ...
    // ⚠ OTA-1156 RETARGET, NOT A REGRESSION. This used to pin the literal
