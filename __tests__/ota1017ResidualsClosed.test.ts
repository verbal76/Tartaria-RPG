...
// OTA-1017 — the four documented residuals, closed (owner: "complete 1-4 that
...
describe('OTA-1017 — the reclaim: real gear captured at death, real gear back', () => {
  const fusedSword = {
...
describe('OTA-1017 — legacy seeded kits pin on first generation', () => {
...
describe('OTA-1017 — the sky is remembered per location', () => {
...
describe('OTA-1017 — Hollowed polish', () => {
...
describe('OTA-1017 — the preview promises the scaled heal', () => {
