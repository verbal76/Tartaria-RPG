// OTA-1022 — the fail-open loss holes, closed (snapshot-audit batch B). Four
...
describe('OTA-1022 — the quest lock fails CLOSED for every catalog quest item', () => {
...
describe('OTA-1022 — the forge blocklists fail CLOSED', () => {
...
describe('OTA-1022 — canonical kind and rarity', () => {
...
describe('OTA-1022 — collect_only fails CLOSED for every Skyreacher reward', () => {
