// OTA-1128 — QWEN CALL TELEMETRY: THE MEASUREMENT BEFORE THE CUT.
//
// OTA-1116 deferred the 29-second-generation fix on purpose: "it gets
...
describe('OTA-1128 — the aggregates are arithmetic', () => {
...
describe('OTA-1128 — every consumer is labeled', () => {
  it('⚠ the runtime records at the ONE boundary every consumer crosses, with the wait split', () => {
    ...
    // RETARGETED BY OTA-1142: both outcomes now split on whether the native
