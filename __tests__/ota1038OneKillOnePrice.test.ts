...
// OTA-1038 — ONE KILL, ONE PRICE + STEALTH KEEPS ITS PROMISES. From the owner's
...
describe('OTA-1038 — one kill costs a faction once', () => {
...
describe('OTA-1038 — a failed sneak costs what the game says it costs', () => {
...
describe('OTA-1038 — SOURCE LOCKS (category: one event, one price; promises are charged)', () => {
  ...
  it('the stealth title rides the deciding contest, not just the gate', () => {
    // OTA-1109 — the handler no longer rolls its own player d20 at all, so
    ...
    // and the engaged reset contests that same total. The OTA-1038 claim
