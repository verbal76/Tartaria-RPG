...
describe('OTA-1186 — time reads as time', () => {
...
describe('OTA-1186 — the card tells the truth about the job', () => {
  ...
  it('⚠ CLAIM 2 — "no turn-in", and the payout really fires from the kill handler', () => {
    ...
    // same block": OTA-1188 added the anti-camp bookkeeping between the kill check and the
...
describe('OTA-1186 — the count is explained, and the explanation tracks the code', () => {
...
describe('OTA-1186 — it fires once, on the first contract', () => {
  beforeEach(async () => {
...
describe('OTA-1186 — the feed stopped implying the place is a requirement', () => {
...
describe('OTA-1186 — the presentation overrides cannot shorten or wedge a card', () => {
