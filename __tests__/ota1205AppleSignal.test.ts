// OTA-1205 — MAKE THE APPLE SIGNALS USABLE. Owner: *"I have Apple testers, they need to be
...
//
// ⚠⚠ 2. THE NARRATION ENGINE'S FAILURE REASON WAS INVISIBLE. OTA-1204 put `qwenError` in
...
describe('OTA-1205 — a red iOS check now means something', () => {
...
describe('OTA-1205 — the narration engine says why it failed, in the log', () => {
