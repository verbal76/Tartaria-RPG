// OTA-1157 — THE VOICE WAITED 3,940 ms FOR A JOB THAT THREW ITS OWN WORK AWAY.
//
// OTA-1155 put a timestamp on the voice because the owner was clocking the gap
...
// OTA-1153 already raised the voice ABOVE narration, and that was the right
...
// is unreachable no matter what arrives behind it. OTA-1146 built the escape
...
// copies the shape it was shown. Same class of bug as the OTA-1138 pipe loop:
...
describe('OTA-1157 — every example in the brief is a reply the validator accepts', () => {
  ...
  it('⚠ OTA-1138 IS NOT REGRESSED — still no alternation anywhere in the brief', () => {
...
describe('OTA-1157 — the last unnamed discard finally names its culprit', () => {
...
describe('OTA-1157 — interruptible is a SEPARATE axis from priority', () => {
...
describe('OTA-1157 — the file records the measurement, not just the change', () => {
