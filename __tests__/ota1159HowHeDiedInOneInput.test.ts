...
// OTA-1159 — HOW HE DIED IN ONE INPUT, AND THE CARD THAT HID IT.
//
...
//
// ⚠ THIS IS THE OTA-1156 / OTA-1158 FAMILY, THIRD TIME. A surface disagreeing
...
describe('OTA-1159 — ⚠ the enemy card tells the truth about a boss', () => {
...
describe('OTA-1159 — ⚠ the card no longer claims a range the spawn did not set', () => {
...
describe('OTA-1159 — ⚠ the greeting, and the beat after the name', () => {
  it('"Good —" is gone from the welcome-back pool', () => {
    ...
    // fix rather than on the fix. Same trap ota1138 fell into with the pipes.
...
describe('OTA-1159 — the file records the third instance of one pattern', () => {
