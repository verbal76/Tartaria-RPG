...
const base: TalkContext = {
  ...
  chapter: 'hook', cores: 0, choices: [], // OTA-1065
};
...
describe('OTA-1058 — the slice is three people, and it says so', () => {
  it('OTA-1059 — every authored vendor now has topics, not just the slice', () => {
  ...
  it('OTA-1062 — the non-vendor cast is covered by CLASS, not by name', () => {
    // ⚠ This asserted `hasTopicsFor('roadside:grit_maalen') === false` before
    // OTA-1062 and the change is intended: roadside traders are 24
...
describe('OTA-1058 — warmth opens the conversation up', () => {
  ...
  it('being placed unlocks the next layer', () => {
    // OTA-1091 — was an exact two-item list from when Irma had 7 topics; the
...
describe('OTA-1058 — robbing somebody is not a warmth level', () => {
...
describe('OTA-1058 — the world-state gates', () => {
...
describe('OTA-1058 — authored, deterministic, and finite', () => {
...
describe('OTA-1059 — the story is the fifth gate', () => {
  ...
  it('ALL FIVE gate dimensions the build plan named are live in content', () => {
    // ⚠ The machinery for standing / titles / contracts existed in OTA-1058 and
