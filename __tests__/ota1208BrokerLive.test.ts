...
describe('OTA-1208 — a foreign faction’s mystery closes at the trading post', () => {
  ...
  test('⚠⚠ FLIPPED BY OTA-1224 (P9): a foreign armory now REFUSES your own faction\'s work', async () => {
    ...
    // rather than deleted — the OTA-1216 pattern: a documented behaviour becoming its own
