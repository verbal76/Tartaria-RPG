// OTA-1158 — THE TEXT SAYS WHAT THE CODE DOES, AND SAYS THE PART IT NEVER SAID.
//
// Owner, deciding the second of the design calls OTA-1156 held:
...
describe('OTA-1158 — standing is not a currency', () => {
...
describe('OTA-1158 — the numbers match the constants that drive them', () => {
...
describe('OTA-1158 — the player is told that low standing gets them hunted', () => {
