// ⚠⚠ OTA-1262 — NARRATION TRACK N6: A JS CRASH IS NOT AN ML CRASH.
//
// Ported from golem OTA-1261. `mlHealth` is shared code and the bug is identical
// on this line — the breadcrumb, the threshold and the crash record are the same.
// The evidence quoted below is golem's because that is where the report came from.
//
...
describe('OTA-1262 N6 — the JS crash no longer takes the ML guard down with it', () => {
...
describe('OTA-1262 N6 — the threshold this protects', () => {
