// OTA-1123 — HOMEWORK YIELDS. The harness the homework slots will run on, and
...
//
// The bank's rest-filler (OTA-1122) is wired as the FIRST homework job, so this
...
describe('OTA-1123 — ⚠ homework in flight is cut short, not waited out', () => {
...
describe('OTA-1123 — the wiring, and the first homework job', () => {
