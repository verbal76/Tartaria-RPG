// OTA-1173 — THE ACID BATCH. Three owner-called dials on the one coating that
...
describe('OTA-1173 — dial 1: the shred cap comes down', () => {
  ...
  it('the boss headroom is unchanged — OTA-1165 already tuned that half', () => {
    // 6 → 2 was the OTA-1165 call and it stays; this batch only moves the base.
...
describe('OTA-1173 — dial 2: the guard knits back', () => {
...
describe('OTA-1173 — dial 3: the second coating slot pays half', () => {
