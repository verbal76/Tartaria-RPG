...
// ⚠⚠ OTA-1300 (port of golem OTA-1298) — THE GAME WAS PRINTING TWO DIFFERENT NORTHS, BACK TO BACK.
//
...
describe('OTA-1300 (port of golem OTA-1298) — the overland compass stays outdoors', () => {
