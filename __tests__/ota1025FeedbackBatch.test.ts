// OTA-1025 — PLAYER-FEEDBACK BATCH. Locks the three fixes from the owner's
...
describe('OTA-1025 — Guardians: over-level damage bonus', () => {
...
describe('OTA-1025 — resonance hook rarer + varied', () => {
...
describe('OTA-1025 — SOURCE LOCKS (category: the row wraps, not shrinks)', () => {
