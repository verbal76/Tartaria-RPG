// ⚠⚠ OTA-1360 — THE SEAL: HMAC-SHA256, checked against published vectors.
//
// GOLEM LINE ONLY.
//
...
describe('OTA-1360 — SHA-256 against the published digests', () => {
...
describe('OTA-1360 — HMAC against RFC 4231', () => {
...
describe('OTA-1360 — sealing a payload', () => {
