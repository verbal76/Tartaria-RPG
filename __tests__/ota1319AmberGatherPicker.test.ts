// ⚠⚠ OTA-1319 — AND THIS TIME ON THE MODAL THE PLAYER ACTUALLY SEES.
//
// OTA-1316 recoloured `SalvageModal.tsx`. That file has had ZERO importers since
...
describe('OTA-1319 — the picker the player opens is the one that changed', () => {
