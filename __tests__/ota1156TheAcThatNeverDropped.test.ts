...
//
// ⚠ AND THE INSTRUMENTATION MISSED IT FOR A REASON WORTH RECORDING. OTA-1147's
...
describe('OTA-1156 — ⚠ player.ac is the racial base and nothing updates it', () => {
...
describe('OTA-1156 — ⚠ the reported "16 → 10" reproduced, and fixed', () => {
...
describe('OTA-1156 — ⚠ every surface answers with the SAME function', () => {
...
describe('OTA-1156 — what combat keeps, and why that is not a contradiction', () => {
