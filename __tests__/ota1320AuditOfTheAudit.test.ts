// ⚠ PORTED FROM THE GOLEM LINE. Golem is the model line, so its version of this
// suite is authoritative; the OTA numbers in the commentary below are GOLEM's,
// which is the honest provenance for where the behaviour was written.
...
// ⚠ OTA-1335 — ONE LIVING CHARACTER PER NAME now holds at the tutorial name beat,
