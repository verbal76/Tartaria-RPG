...
// OTA-962 — escort missions, ported from engine_Dev's shared-pool model. An
...
describe('OTA-962 — escort engine: spec, pool, HUD filter', () => {
...
describe('OTA-962 — collateral bleeds the party when the player is hit', () => {
...
describe('OTA-962 — rest patches the party up, modestly', () => {
