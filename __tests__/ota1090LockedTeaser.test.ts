// OTA-1090 — THE DOOR THE PLAYER CAN SEE. 141 of 182 topics sit behind gates,
...
// in-voice deflection. Plus two new gate roads for the OTA-1091 authoring
...
describe('OTA-1090 — locked-topic count (the teaser number)', () => {
...
describe('OTA-1090 — the teaser NEVER leaks a label', () => {
...
describe('OTA-1090 — in-voice deflections', () => {
...
describe('OTA-1090 — the two new gate roads', () => {
...
describe('OTA-1090 — authoring lock: every gate key in the JSON is a real gate', () => {
