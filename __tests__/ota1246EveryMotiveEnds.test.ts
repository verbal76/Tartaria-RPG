...
// ⚠⚠ OTA-1246 — EVERY REASON YOU CAME DOWN NOW ENDS SOMEWHERE. Owner, after the
...
//
// ⚠⚠ HARNESS TRAPS: the ota1242HuntWalker header's five all apply. One of this
// file's own:
...
describe('OTA-1246 — the authoring audit: no motive without an ending', () => {
...
describe('OTA-1246 — LIVE: every motive answers itself at a Lost Capital', () => {
