// OTA-1116 — FIVE FROM THE DEVICE LOG (2026-08-04, Pixel 10 Pro XL, 4.29.26).
//
...
describe('OTA-1116 #1 — a weakness that is rolled off becomes ORDINARY, not armour', () => {
...
describe('OTA-1116 #3 — the Arbiter uses a faction fighter\'s NAME', () => {
...
describe('OTA-1116 — source locks for the store-side fixes', () => {
