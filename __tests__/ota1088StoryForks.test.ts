...
describe('OTA-1088 — the authored forks', () => {
  ...
  it('⚠ story standing is one-shot by construction, not by a guard', () => {
    // OTA-1087 closed two rival-standing farms built out of REPEATABLE acts.
...
describe('OTA-1088 — ⚠ a question cannot be lost', () => {
...
describe('OTA-1088 — lasting consequence, all three places', () => {
...
describe('OTA-1088 — in the real store', () => {
