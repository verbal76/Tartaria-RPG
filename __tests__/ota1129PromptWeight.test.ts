// OTA-1129 — ⚠ THE STALL WAS THE PROMPT, NOT THE MODEL.
//
// OTA-1128's telemetry shipped and the first device log answered the question
...
//   flourish (OTA-1086 timer)  2087ms
//
...
describe('OTA-1129 — the pack manifest is capped', () => {
...
describe('OTA-1129 — ambient reads a lean prompt', () => {
