// OTA-1085 — store-level regressions for the behavioral fixes:
...
describe('OTA-1085 A1 — enemy DOTs tick on a non-attack combat round (dodge)', () => {
...
describe('OTA-1085 A1 — jump trains DEX only on a resolved scene noun', () => {
...
describe('OTA-1085 A2 — pickup cannot launder a worn instance into a full stack', () => {
...
describe('OTA-1085 A2 — applyCoating peels one unit off a stack', () => {
