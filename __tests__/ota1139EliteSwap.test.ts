// OTA-1139 — THE ELITE SWAP.
//
// The last of OTA-1136's nine dials to find a consumer, and the one the survey
...
describe('OTA-1139 — the dial decides, and `owed` never sees it', () => {
...
describe('OTA-1139 — the elite is exactly as durable as the party it replaced', () => {
...
describe('OTA-1139 — it is a NAMED body, not a silent stat inflation', () => {
...
describe('OTA-1139 — ⚠ the carry, which is the only way this could underpay', () => {
...
describe('OTA-1139 — the things it must never touch', () => {
...
describe('OTA-1139 — the store wires it where a party spawns, and nowhere else', () => {
...
describe('OTA-1139 — the audit is recorded so it is not re-litigated', () => {
