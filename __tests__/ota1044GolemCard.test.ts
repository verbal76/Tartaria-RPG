/**
 * OTA-1044 — the golem naming card brought in line with the dog card.
 *
 * The owner reported three faults against DogOnboardingModal (OTA-1043). Its
...
describe('OTA-1044 — the golem name pool', () => {
...
describe('OTA-1044 — golem ROLL walks a shuffle bag', () => {
  beforeEach(() => _resetGolemNameBag());
