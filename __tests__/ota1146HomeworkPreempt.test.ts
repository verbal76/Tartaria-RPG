...
describe('OTA-1146 — homework is the lowest priority there is', () => {
  it('⚠ the tiers are ordered homework < narration < VOICE (reordered by OTA-1153)', () => {
    // ⚠ RE-AUTHORED, NOT RE-NUMBERED. OTA-1146's claim was "homework is the
    ...
    // OTA-1153 put the voice ABOVE narration, reversing OTA-634, because the
    ...
    // The invariant OTA-1146 actually owns, stated directly: nothing ranks
    // below homework.
  ...
  it('⚠ a queued homework job runs LAST, behind voice and narration', async () => {
    ...
    // ⚠ RETARGETED BY OTA-1153 — voice and llm swap places. Homework still runs
    // LAST, which is what this test is named for and what OTA-1146 secured.
...
describe('OTA-1146 — the wiring, and the first homework job', () => {
  ...
  it('⚠ NARRATION supplies no hook — it is the one that must never be cut', () => {
    // ⚠ RE-AUTHORED, NOT RE-NUMBERED. OTA-1146's claim was "only homework
    // supplies a hook", and that is no longer true: OTA-1157 gave item
    ...
    //
    // What OTA-1146 actually secured, and what still holds, is the other side:
