...
const EXPECTED_BEAT_IDS = [
  // 'look' is the first ACTION beat (after name, before take) — get your
  // bearings before anything else. Door-open branch (arb4): the old
  // move_north / read_note beats were replaced by an explore_or_leave popup.
