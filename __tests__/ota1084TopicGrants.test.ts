...
/**
 * OTA-1084 — CONVERSATION THAT GIVES YOU SOMETHING.
 *
 ...
 *    OTA-1083 only reopened it behind a lifetime budget. A topic that granted
...
describe('OTA-1084 — talk can pay, in the two currencies it is allowed', () => {
  ...
  it('⚠ NO TOPIC GRANTS STANDING — the second door stays shut', () => {
    // OTA-803 deleted gifting over exactly this. OTA-1083 reopened the verb only
...
describe('OTA-1084 — you have to have earned the useful ones', () => {
...
describe('OTA-1084 — the store pays once, and reads one fact to decide', () => {
  // eslint-disable-next-line @typescript-eslint/no-require-imports
