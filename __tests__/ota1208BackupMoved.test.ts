...
// OTA-1208 — THE BACKUP MOVED ROOMS, IT DID NOT NARROW. Owner: the OTA-1178
...
describe('OTA-1208 — the shared backup routine', () => {
...
describe('OTA-1208 — both doors exist and share the one routine', () => {
  ...
  it('settings RUN card: BACK UP CHARACTER exists and SAVES FIRST', () => {
    ...
    // loses the session the player is standing in (the OTA-1178 wound anew).
