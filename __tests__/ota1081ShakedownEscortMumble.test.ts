...
/**
 * OTA-1081 — THE SHAKEDOWN, THE CLIENT'S COAT, AND THE MUMBLE.
 *
...
describe('OTA-1081 — pay them off when caught (vendor)', () => {
...
describe('OTA-1081 — the client’s coat (escort leaders)', () => {
