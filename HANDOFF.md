...
history in `HANDOFF-ARCHIVE.md`). Latest per line: **HaL2001 `2026-07-15-831`**,
**golem-line `…-811`**, **engine_Dev `…-1116`** (830 was HAL+golem-only — Guardian
gear is Tartaria content, engine has no coreGuardians — so the +285 spread narrowed
by 1 there; 831 code ships to all three, so engine resumes at 1116, now HAL+286).
Current parity offsets: golem =
