...
history in `HANDOFF-ARCHIVE.md`). Latest per line: **HaL2001 `2026-07-16-844`**,
**golem-line `…-824`**, **engine_Dev `…-1125`** (843–845 = the Tier-3 emergent-depth
batch. 844 = World Pulse (factions drift offscreen + rumours), ships to all three.
