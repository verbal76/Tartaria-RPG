...
> **Latest OTA:** `2026-05-28-132` (Hook-puzzle wave SHIP-READY — OTA-131 pressure sweep added 35 new tests across 5 files (1000 input variants, save/load mid-puzzle, abandonment, mercy thresholds) and surfaced 1 genuine bug: puzzle solve advanced stage but skipped the inline stage-1 reward. OTA-132 fixed it with a 1-line stage-bump in the solve branch. 122/122 puzzle + regression tests pass. Longest-standing open hook-puzzle issue closed across OTAs 129/130/131/132). See **Section 0** for the live issue tracker covering OTA-070 → OTA-132.
> **Recent session arcs:**
