...
history in `HANDOFF-ARCHIVE.md`). Latest per line: **HaL2001 `2026-07-14-810`**,
**golem-line `…-790`**, **engine_Dev `…-1095`**. Current parity offsets: golem =
HAL − 20 (stable); engine_Dev = HAL + 285 (the Guardian OTA 798/778 was
HAL+golem-only, so engine is one behind on count; the hunts-face-to-face batch 810/790/1095
