...
- **⚠⚠ NEXT UP — SCOPED, INVESTIGATED, NOT BUILT: the Contracts "READY TO HAND IN" sort
  (golem OTA-1152 / HAL OTA-1175).** Owner, verbatim: *"also under contracts you have sort by distance and
  ...
  | contract kind | how "ready" is decided | site (HAL line numbers; golem is close but re-grep) |
  |---|---|---|
  ...
  **Everything needed, already located in `ContractsScreen.tsx`:**
  ...
  Then the usual: new suite, gates (typecheck / lint / ratchet **202 on golem** / `test:ci:fast`), docs
  ritual, and parity against HAL's OTA-1175.
