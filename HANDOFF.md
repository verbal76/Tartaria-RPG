...
history in `HANDOFF-ARCHIVE.md`). Latest per line: **HaL2001 `2026-07-15-830`**,
**golem-line `…-810`**, **engine_Dev `…-1115`**. Current parity offsets: golem =
