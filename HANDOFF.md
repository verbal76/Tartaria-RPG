...
history in `HANDOFF-ARCHIVE.md`). Latest per line: **HaL2001 `2026-07-14-811`**,
**golem-line `…-791`**, **engine_Dev `…-1096`**. Current parity offsets: golem =
HAL − 20 (stable); engine_Dev = HAL + 285 (the Guardian OTA 798/778 was
HAL+golem-only, so engine is one behind on count; the placeholder-cleanup batch 811/791/1096
