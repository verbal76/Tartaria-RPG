...
history in `HANDOFF-ARCHIVE.md`). Latest per line: **HaL2001 `2026-07-16-836`**,
**golem-line `…-816`**, **engine_Dev `…-1117`** (836 is the first of three Tier-1
QoL OTAs — "make the depth visible" — and ships to all three lines: it's pure
character-sheet UI + a display helper, no lore. 835 ships to ALL THREE — the engine
