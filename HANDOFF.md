...
history in `HANDOFF-ARCHIVE.md`). Latest per line: **HaL2001 `2026-07-15-834`**,
**golem-line `…-814`**, **engine_Dev `…-1115`** (834 is HAL+golem-only — Tartaria
race/faction content. 833 was HAL+golem-only — the golem
