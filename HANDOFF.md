...
history in `HANDOFF-ARCHIVE.md`). Latest per line: **HaL2001 `2026-07-14-809`**,
**golem-line `…-789`**, **engine_Dev `…-1094`**. Current parity offsets: golem =
HAL − 20 (stable); engine_Dev = HAL + 285 (the Guardian OTA 798/778 was
HAL+golem-only, so engine is one behind on count; the parley-rewards batch 809/789/1094
