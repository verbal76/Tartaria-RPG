...
history in `HANDOFF-ARCHIVE.md`). Latest per line: **HaL2001 `2026-07-16-835`**,
**golem-line `…-815`**, **engine_Dev `…-1115`** (835 AND 834 are HAL+golem-only —
Tartaria race/faction content; engine's race system is content-pack-driven and
lore-agnostic, so the Tartaria-specific trait wiring has no engine analog. 833 was HAL+golem-only — the golem
