...
history in `HANDOFF-ARCHIVE.md`). Latest per line: **HaL2001 `2026-07-16-840`**,
**golem-line `…-820`**, **engine_Dev `…-1121`** (840 = Tier-2 QoL #1, never-fail-
silently sweep — pure gameStore feedback lines, ships to all three. 839 = a lore-accuracy pass (data)
