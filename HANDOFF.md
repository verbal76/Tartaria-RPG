...
**This checkout:** branch `golem-line` — **HAL's testing branch** — trial HAL improvements here, then promote to HaL2001. Same game, channel `golem-line`, installs side-by-side with HAL.
