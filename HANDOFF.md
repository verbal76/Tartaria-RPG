...
history in `HANDOFF-ARCHIVE.md`). Latest per line: **HaL2001 `2026-07-16-843`**,
**golem-line `…-823`**, **engine_Dev `…-1124`** (843 = Tier-3 depth #1, Character
Chronicle — new engine/chronicle.ts + a Character-sheet section, ships to all three.
