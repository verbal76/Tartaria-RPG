...
**golem-line `…-810`**, **engine_Dev `…-1114`** (830 is HAL+golem-only — Guardian
gear is Tartaria content, engine has no coreGuardians — so engine stays at 1114 and
the +285 spread narrows by 1 for this batch). Current parity offsets: golem =
