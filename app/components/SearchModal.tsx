...
interface Props {
  ...
  onCancel: () => void;
  /** ⚠ OTA-1206 — INVESTIGATE ALL, on the owner's instruction (2026-08-09): *"it should
...
export function SearchModal({ visible, chips, onSubmit, onCancel, onInvestigateAll }: Props) {
  ...
  // OTA-1206 — what INVESTIGATE ALL will actually act on. Locked chips are visible (so the
            ...
            <View style={styles.card}>
              ...
              {visibleChips.length > 0 && (
                <>
                      ...
                      return (
                        ...
                        >
                          <Text
                            ...
                            numberOfLines={1}
                          >
                            {/* OTA-1229 — ✦ = the torch marked this noun as actually
                  ...
                  {/* ⚠ OTA-1206 — INVESTIGATE ALL. Mirrors SALVAGE ALL (SalvageModal:342)
