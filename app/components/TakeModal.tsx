...
const styles = StyleSheet.create({
  ...
  empty: { color: '#6c8088', fontSize: 12, fontStyle: 'italic', lineHeight: 17, marginVertical: 14 },
  ...
  chipText: { color: '#d6e4e8', fontSize: 14, fontWeight: '600' },
  ...
  chipTextConsumed: { color: '#6c8088', fontStyle: 'italic' },
  ...
  takeAllText: { color: '#0a1012', fontWeight: '800', letterSpacing: 2, fontSize: 13 },
  ...
  btnText: { color: '#bcd2db', fontWeight: '700', letterSpacing: 2, fontSize: 12 },
});
