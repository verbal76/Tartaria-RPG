    ...
    if (quests.length > 0) {
      out.push({
        ...
        postings: quests.map((q) => ({
          ...
          accent: '#6ab0c9', onAccept: () => acceptFactionQuest(q.title),
        })),
      });
    }
    if (hunts.length > 0) {
...
const styles = StyleSheet.create({
  ...
  posting: { flexDirection: 'row', backgroundColor: '#131c1f', borderColor: '#2b3a3e', borderWidth: 1, borderRadius: 4, marginBottom: 8, overflow: 'hidden' },
  stripe: { width: 4 },
