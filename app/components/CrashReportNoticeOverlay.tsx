...
import { Modal, View, Text, Image, TouchableOpacity, Pressable, StyleSheet, ScrollView, useWindowDimensions } from 'react-native';
import {
        ...
        <ScrollView contentContainerStyle={styles.scroll}>
          <View style={styles.card}>
            ...
            <View style={styles.btnRow}>
              <Pressable
                style={({ pressed }) => [kit.ctl, styles.btnGhost, pressed && kit.controlPressed]}
                onPress={turnOff}
