...
// OTA-1104 — the WIS read is DIEGETIC: instead of a bare "WEAK: burn" label, the detail
...
function enemyDetailBody(view: EnemyView, canRead: boolean, observed?: { weak: string[]; resist: string[] }): string {
  ...
  // OTA-1103/1104 — a non-boss enemy's (randomized) defenses are WIS-gated: read them up
  // front only with enough Wisdom, else discover by hitting. OTA-1104 — the read is
...
const styles = StyleSheet.create({
  ...
  // (engine keeps its teal palette — brighter than the base for legibility.)
  hint: { color: '#8a9ea6', fontSize: 12, letterSpacing: 0.3, marginLeft: 8 },
});
