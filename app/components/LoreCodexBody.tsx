...
export function LoreCodexBody() {
  ...
  /** ⚠⚠ OTA-1362 — THE PC LINES CANNOT ASSUME A CLIPBOARD. On a phone
  ...
  /** ⚠ OTA-web10 — one expression, four products. `'open'` short-circuits, so the
    ...
    <View style={styles.bodyWrap}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={{ paddingBottom: 24 }}>
        ...
        {section === 'fallen' && (
          ...
          {/* ⚠⚠ OTA-web10 — THE EXCHANGE, BEHIND THE ONE PRODUCT FLAG.
