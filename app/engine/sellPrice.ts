...
// OTA-1087 (B1c) — "you can never sell an item back for more than the CHEAPEST
...
// OTA-1087 (B1b) — bottleneck CRAFTING materials (Golem/aether fuel + Mud-Golem
...
/** OTA-1087 (B1a) — the raw SELL value of a named material/item, for costing a
...
/** OTA-1087 (B1a) — sell cap for a SELF-CRAFTED item: the summed raw-sell value of
