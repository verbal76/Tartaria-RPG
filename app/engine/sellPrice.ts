...
export function sellPriceFor(
  ...
  // ⚠ OTA-1337 — the modifier can be NEGATIVE now (the standing ladder's hostile
  ...
  // ⚠ OTA-1336 — gear sells in a QUALITY BAND (0.35–0.5 of base) instead of the
 ...
 *  ⚠ OTA-1336 — WEAPONS TOO, VIA THE FIELD THE STALL ACTUALLY READS. The owner:
...
/** ⚠ OTA-1336 — WHOLE-INSTANCE quality, folded into gear resale. The owner's own
