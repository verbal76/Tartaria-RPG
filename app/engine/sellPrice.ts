...
export function sellPriceFor(
  ...
  // ⚠ OTA-1341 — the modifier can be NEGATIVE now (the standing ladder's hostile
  ...
  // ⚠ OTA-1340 — gear sells in a QUALITY BAND (0.35–0.5 of base) instead of the
 ...
 *  ⚠ OTA-1340 — WEAPONS TOO, VIA THE FIELD THE STALL ACTUALLY READS. The owner:
...
/** ⚠ OTA-1340 — WHOLE-INSTANCE quality, folded into gear resale. The owner's own
