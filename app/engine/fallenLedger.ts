...
/** Gear pieces per fallen — a full loadout is ten slots (OTA-1363). */
...
// ⚠⚠ OTA-1363 — THE UPGRADES TRAVEL. Owner: *"most of the dead will have
...
/** ⚠⚠ OTA-1363 — THE NAME GATE. Owner: *"port the feature to Hal, but make it
...
/** ⚠⚠ OTA-1363 — THE CLONE CROSSES. Owner: *"I want a clone sent."*
 *
