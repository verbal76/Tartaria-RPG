...
export interface WastelandArchetype {
  ...
  /** OTA-1002 — provocable NPC encounter. When a `type:'npc'` archetype
...
/** OTA-1002 — data-driven provoke payload for a provocable NPC encounter. */
...
export interface WastelandEncounter {
  ...
  /** OTA-1002 — provoke payload for a provocable NPC encounter, else null. */
