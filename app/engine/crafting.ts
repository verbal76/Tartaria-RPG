...
export function findRecipeByResult(target: string): Recipe | null {
  ...
  // match — so EVERY hyphenated recipe (Aether-Shard Spear, Aether-Wing Cloak, Golem
  // Aether-Lance, Aether-Reinforced Armor…) returned null, kicking the craft into an
