...
const baseRooms = (areaName: string) => [
  ...
  room('store', 'Store', 'Shelves of crates and spare kit. A quartermaster keeps the counter.', { west: 'yard' }, false, 'Quartermaster'),
];
...
export const GENERIC_GAME = {
  ...
  dogScenarios: [
    ...
    {
      id: 'rope', hookNouns: ['rope', 'stake', 'tether'],
    ...
    {
      id: 'snare', hookNouns: ['snare', 'snare pit', 'trapper camp'],
