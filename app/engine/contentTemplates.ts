...
export function buildDogScenariosTemplate(): string {
  return [
    ...
    '//   hookNouns       [array] The trigger words. Matching is WHOLE-WORD, so',
    '//                   "ash" fires on "ash tree" but NOT "trash", and "airlock"',
    '//                   fires on "the airlock" but NOT a bare "lock". A two-word',
    '//                   noun ("snare pit") also fires on either word ("snare"/"pit").',
    '//                   Prefer distinctive nouns; avoid ones that ARE a common',
    '//                   word the player types all the time.',
