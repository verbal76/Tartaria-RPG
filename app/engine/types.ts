...
export type Intent =
  ...
  | 'push'
  | 'pull'
  // OTA-1000 — call-to-action gestures. Evocative verbs a scene's prose
...
export interface PlayerCharacter {
  ...
  /** OTA-1086 — game-hours mark until which arrival encounters are suppressed after
  ...
  /** OTA-1094 — a LOCATION LEAD talked out of a wandering NPC (persuade reward). Paid
   *  out the next time the player reaches fresh ground (beginScene on a novel tile).
   *  Cleared on payout. One at a time — a fresh lead overwrites an unclaimed one. */
  ...
  /** OTA-963 — set when the player DECLINES the stumbled-onto parley offer, so
  ...
  /** OTA-1002 — a live provocable NPC travel encounter (e.g. the Aetherkin
...
export interface WorldMemory {
  ...
  /** OTA-1085 — per-water-source use timestamps (game-hours, i.e. player.
  ...
  /** OTA-1092 — outdoor tiles that have already ROLLED for a wandering NPC (see
