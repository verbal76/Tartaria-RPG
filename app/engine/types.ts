...
export interface PlayerMilestones {
  ...
  /** OTA-1321 — the first-fight combat primer has been shown to this character. */
...
export interface PlayerCharacter {
  ...
  /** ⚠ OTA-1306 — the Great Climb the player has set course for, so the tower
  ...
  /** ⚠⚠ OTA-1371 — BOTH NAMES ARE DECLARED, ON EVERY LINE, and that is the
...
export interface WorldMemory {
  ...
  /** OTA-1335 — one-time "the Spire moved" notice. The Grand Spire of Asgardar
  ...
  /** OTA-1339 — one-time acid-lore beat: the first acid coat a character paints,
...
export interface VisitedRoom {
  ...
  /** ⚠⚠ OTA-1367 — THE GEAR THIS ROOM HOLDS, DECIDED ONCE.
   *
