...
export function emptyMemory(): WorldMemory {
  return {
    ...
    defeatedEnemies: [],
    completedQuestIds: [],
    // OTA-1334 — fresh characters chart the Grand Spire of Asgardar where it now
...
// ⚠ OTA-1334 — the map makeover moved the Grand Spire of Asgardar out of the capital
