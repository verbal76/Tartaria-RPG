...
export function emptyMemory(): WorldMemory {
  return {
    ...
    defeatedEnemies: [],
    completedQuestIds: [],
    // OTA-1339 — fresh characters chart the Grand Spire of Asgardar where it now
...
// ⚠ OTA-1339 — the map makeover moved the Grand Spire of Asgardar out of the capital
...
export function recordEnemyDefeat(memory: WorldMemory, enemyName: string): WorldMemory {
  // OTA-800 — defeatedEnemies is a DISTINCT-name set of first kills, not a
...
// OTA-800 — wild-water re-arm. A cupped drink / bottle refill from a wild water
