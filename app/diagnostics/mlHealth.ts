...
interface MLHealthState {
  ...
  /** ⚠⚠ OTA-1262 (N6) — the dangling init breadcrumb was EXPLAINED by a JS-thread
...
export async function loadMLHealth(): Promise<MLHealthState> {
  ...
  // ⚠⚠ OTA-1262 (N6) — A JS CRASH IS NOT AN ML CRASH, AND THIS COULD NOT TELL
...
export function mlHealthSummary(): string {
  ...
  if (state.disabledByCrash) {
    ...
    // ⚠ OTA-1262 (N6) — SAID OUT LOUD, not swallowed. The breadcrumb was found and
