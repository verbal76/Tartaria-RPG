...
export interface PressureSnapshot {
  ...
  /** ⚠ OTA-1359 — the native-ML queue, which is the half of "is the app
...
let rpLastBreadcrumb: {
  ...
  // OTA-1351 — the phase checkpoints (see saveSystem.stampBreadcrumbPhase).
...
export function runtimePressureSummary(s: PressureSnapshot): string {
  ...
  if (rpLastBreadcrumb) {
    ...
    // OTA-1351 — the phase names WHERE in that activity's life the app died:
  ...
  // ⚠⚠ OTA-1359 — THE LINE THAT EXPLAINS A NEAR-FREEZE THE WATCH CANNOT SEE.
