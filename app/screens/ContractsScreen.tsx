    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
        ...
        {(() => {
          ...
          // ⚠ OTA-1357 — the towers join the distance sort. Owner: "they should get
              ...
              {climbsInOrder.map((c) => {
                ...
                return (
                  <View key={c.id} style={styles.card}>
                    ...
                    {/* ⚠⚠ OTA-1306 — THE FIVE TOWERS WERE THE ONLY MISSIONS YOU
                    ...
                    {/* ⚠ OTA-1357 — THE TOWERS TOGGLE LIKE EVERY OTHER MISSION.
            ...
            <View style={styles.routeBtnRow}>
              ...
              <Pressable
                ...
                onPress={() => {
                  ...
                  if (missionId) {
                    // ⚠ OTA-1346 — B6: inside an outpost, a mission route asks the
                  ...
                  if (pendingRoute.climbId) {
                    // ⚠ OTA-1346 — B6: same rule for a tower's SET COURSE.
                    if (player.hubRoomId) {
...
const styles = StyleSheet.create({
  ...
  // ⚠ OTA-1357 — THE ACTIVE ONE GLOWS. Owner: "the set active buttons should glow
