...
const styles = StyleSheet.create({
  ...
  // OTA-859 — re-route to a held bounty (outline button, secondary to the teal ACCEPT).
  bountySecondaryBtn: { marginTop: 9, borderColor: '#6ab0c9', borderWidth: 1, borderRadius: 3, paddingVertical: 8, alignItems: 'center' },
  bountySecondaryText: { color: '#6ab0c9', fontSize: 11, fontWeight: '700', letterSpacing: 1 },
});
