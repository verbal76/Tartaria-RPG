...
const styles = StyleSheet.create({
  ...
  // OTA-848 — tap-to-expand affordances + readable breakdown lists (engine teal palette).
  tapHint: { color: '#6c8088', fontSize: 11, fontWeight: '400' },
  tapHintLine: { color: '#6c8088', fontSize: 9, fontStyle: 'italic', marginTop: 3, letterSpacing: 0.3 },
  breakdownList: { marginTop: 6, borderTopColor: '#2b3a3e', borderTopWidth: 1, paddingTop: 6 },
  ...
  breakdownLabel: { color: '#bcd2db', fontSize: 12, flex: 1 },
  breakdownTotalRow: { marginTop: 3, borderTopColor: '#2b3a3e', borderTopWidth: 1, paddingTop: 5 },
  breakdownTotalDelta: { color: '#d6e4e8', fontSize: 13, fontWeight: '800', width: 40 },
  breakdownTotalLabel: { color: '#d6e4e8', fontSize: 12, fontWeight: '700', flex: 1 },
  growsFrom: { marginTop: 6 },
  growsFromHead: { color: '#6ab0c9', fontSize: 10, letterSpacing: 0.5, marginBottom: 3, fontWeight: '700' },
  growsFromItem: { color: '#a8bcc2', fontSize: 11, lineHeight: 16, marginLeft: 2 },
  ...
  chronicleDeed: { color: '#bcd2db', fontSize: 12, lineHeight: 18 },
  chronicleTimeline: { marginTop: 10, borderTopColor: '#2b3a3e', borderTopWidth: 1, paddingTop: 8, gap: 6 },
  chronicleRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 8 },
  chronicleGlyph: { color: '#6ab0c9', fontSize: 13, width: 16, textAlign: 'center' },
  chronicleEntryText: { color: '#a8bcc2', fontSize: 12, lineHeight: 18, flex: 1 },
  chronicleEmpty: { color: '#6c8088', fontSize: 12, fontStyle: 'italic', marginTop: 8 },
