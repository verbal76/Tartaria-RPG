...
export function ExplorationScreen() {
  ...
  // OTA-1234 — a RESOLVED hook's noun must grey like any spent chip. The
  ...
  const isAmbientConsumed = (noun: string): boolean => {
    ...
    // ⚠⚠ OTA-1254 — THE FLAVOR LIST IS NOT A CONSUMPTION LIST, AND READING IT HERE
    ...
    // OTA-953 — searched keeps the loose fuzzy rule.
    ...
    >
        ...
        {pendingRolls ? (
          ...
          <InputBox
            ...
            investigateCount={(() => {
              ...
              // OTA-1233 — eye-only chips (a marked story lead that is not an
              // ambient noun) are actionable too; the count and the modal must
              // agree, per the OTA-1147 rule.
      ...
      <SearchModal
        ...
        chips={tutBeat === 'investigate' ? [{ noun: 'door', consumed: false }] : [
          ...
          ...buildChipPool(currentScene)
            .map((n) => {
              ...
              return {
                ...
                unmetRequirement,
                // OTA-1229 — ✦ when the Aetheric Torch has flagged this noun as
          ...
          // ⚠ OTA-1233 — eye nouns that are NOT ambient chips (a charged story
        ...
        chips={
          tutBeat === 'scrap'
            ...
            : reachableWhileElevated(
                ...
                // chips lit.
                // ⚠⚠ OTA-1254 — `isNounFlavorExhausted` REMOVED from this predicate.
