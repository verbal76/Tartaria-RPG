...
const styles = StyleSheet.create({
  ...
  collapsedHeader: {
    ...
    backgroundColor: '#0e1618', borderColor: '#2b3a3e', borderWidth: 1, borderRadius: 4,
    paddingHorizontal: 8, paddingVertical: 5, gap: 8,
  },
  collapsedHeaderText: { color: '#6ab0c9', fontSize: 11, letterSpacing: 0.5, flex: 1, minWidth: 0 },
  collapsedHeaderChevron: { color: '#4a6870', fontSize: 12, fontWeight: '700' },
