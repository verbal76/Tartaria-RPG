      ...
      <View style={styles.rowBody}>
        <View style={styles.rowHead}>
          ...
          {/* OTA-688 — a Crucible-forged item wears a magical ✶ star (rarity-colored),
              distinct from the ◆ inferred diamond, so one-of-a-kind fused gear reads
              at a glance. Fused items are catalog-absent but NOT "inferred", so they
              never showed the ◆ — now they carry their own mark. */}
...
const styles = StyleSheet.create({
  ...
  // OTA-688 — Crucible-forged marker. Same weight as the inferred diamond but a
  // magical ✶ star, rarity-colored, so a one-of-a-kind fused piece stands out.
