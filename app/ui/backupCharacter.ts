// backupCharacter.ts — OTA-1231. ONE implementation of "back up this character".
//
// OTA-1201 put a BACK UP button on every character row after the owner lost a
...
//
// ⚠ SHARE FIRST, CLIPBOARD SECOND — OTA-1201's own scar tissue, unchanged: a
