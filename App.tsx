...
try {
  ...
  if (errorUtils?.setGlobalHandler) {
    ...
    errorUtils.setGlobalHandler((err, isFatal) => {
      ...
      // ⚠⚠ OTA-web10 — AND THE LEDGER, which is the durable copy. The
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // ⚠⚠ OTA-web10 — hydrate the crash ledger and the delivery preference at
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: { componentStack?: string }) {
    ...
    // ⚠ OTA-web10 — a recovered screen crash is still a crash, and it is the one
